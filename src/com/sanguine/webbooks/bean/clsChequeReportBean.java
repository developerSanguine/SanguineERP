...
public class clsChequeReportBean 
{
	...
	private String strBankOrCFCode;
	...
	public String getStrBankOrCFCode() {
		return strBankOrCFCode;
	}

	public void setStrBankOrCFCode(String strBankOrCFCode) {
		this.strBankOrCFCode = strBankOrCFCode;
	}
