...
public class clsJVDetailsBean {
	...
	public String getStrOneLineAcc() {
		return strOneLineAcc;
	}

	public void setStrOneLineAcc(String strOneLineAcc) {
		this.strOneLineAcc = strOneLineAcc;
	}
