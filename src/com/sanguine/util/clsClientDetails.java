...
public class clsClientDetails {
	...
	public static void funAddClientCodeAndName() {
		try {
			...
			hmClientDtl.put("000.000", clsClientDetails.createClientDetails("000.000", "Demo Company", dFormat.parse("2014-06-19"), dFormat.parse("2022-03-21")));
			...
			hmClientDtl.put("136.001", clsClientDetails.createClientDetails("136.001", "KINKI", dFormat.parse("2017-01-05"), dFormat.parse("2023-01-05")));// released on
			...
			hmClientDtl.put("153.000", clsClientDetails.createClientDetails("153.000", "MALGUDI FOODS PVT LTD", dFormat.parse("2021-09-23"), dFormat.parse("2021-10-25")));// renewed on 23-09-2021 for 1 month
			...
			hmClientDtl.put("211.001", clsClientDetails.createClientDetails("211.001", "CHEFS CORNER", dFormat.parse("2017-11-29"), dFormat.parse("2022-02-28")));//renewed on 25-06-2019 for 10 days till 09-07-2019//Renewed On 17-05-2019 for 15 days till 31-05-2019// Renewed on 16-04-2019 for 1 month till 16-05-2019//Renewed on 14-03-2019 for 1 month till 16-04-2019//renewed on 15-02-2019 for 1 month till 15-03-2019 //renwed for on emonth on 01-12-2018 till  //renewed  on 30-11-2018 for one month till 30-12-2018  // renewd
			...
			hmClientDtl.put("225.001", clsClientDetails.createClientDetails("225.001", "SHEESHA SKY LOUNGE HOSPITALITY AND SERVICES PVT LTD", dFormat.parse("2018-08-21"), dFormat.parse("2023-01-02")));//From POS 
			...
			hmClientDtl.put("240.001", clsClientDetails.createClientDetails("240.001", "THOUSAND OAKS", dFormat.parse("2018-04-12"), dFormat.parse("2023-03-30")));//renewed on 06-11-2020 for 10 days till 17-11-2020//renewed on 22-05-2019 for 1 year//renewed on 01-12-2018 for one month till 01-01-2019//renewed on 20-08-2018 for 1 week till 27-08-2018 //renewed on 13-06-2018 for 1 month// Mr. Sanjeet Lamba", 2417 East Street (G T Road),Camp, Pune 411001. Tel: (020) 2634 3194 / 2634 5598
			...
			hmClientDtl.put("244.001", clsClientDetails.createClientDetails("244.001", "VIVIDH HOSPITALITY", dFormat.parse("2021-09-01"), dFormat.parse("2022-08-31")));//release on 17-04-2018 for 1 year till 17-04-22019
		   ...
		   //260.001", "PARAG HOTELS AND RESORT PVT LTD" for POS
			...
			hmClientDtl.put("262.001", clsClientDetails.createClientDetails("262.001", "COCO JAMBO", dFormat.parse("2018-09-08"), dFormat.parse("2022-09-08")));//(AFRICA)//Renewed on 18-09-2019 foe 1 year till 08-09-2020//Renewed on 07-09-2019  till 18-09-2019 //released on 08-09-2018 for 1 year till 08-09-2019 
			...
			hmClientDtl.put("267.001", clsClientDetails.createClientDetails("267.001", "THE MASTER CLOCK & WATCH WORKS PVT LTD", dFormat.parse("2018-10-04"), dFormat.parse("2022-12-14")));//Renewed on 12-03-2019 for 1 year till 25-12-2019 //renewed on 06-12-2018 for one month till 06-01-2019// One month stsrt date 2018-10-04  end date Office	AddressB-304,	Dynasty	Business	Park,J.B.Nagar,Andheri	Kurla	Road,	Andheri	East	Mumbai-400059. Contact	Person(s)-Mr.Sandesh,Contact	Number(s)9987994188  Email	ID Sandesh.aga@gmail.com //MUBASHIR//Renew  on 04-05-2018			
			hmClientDtl.put("268.001", clsClientDetails.createClientDetails("268.001", "ROVE HOSPITALITY", dFormat.parse("2021-08-13"), dFormat.parse("2022-08-12")));//renewed on 21aug for 1 year (Glint)//Renewed on 16-10-2019 for one year till 2020-10-15//(Pune)//renewed on 23-11-2018 for 1 year till 15-10-2019 "Amol Gargote", "9545160160", "amololive6@gmail.com", 			
			...
			hmClientDtl.put("318.001", clsClientDetails.createClientDetails("318.001", "SOY COMO SOY", dFormat.parse("2022-06-15"), dFormat.parse("2023-06-15"))); // renewed on 04-06-2019 for 1 month till 04-07-2019
			hmClientDtl.put("319.001", clsClientDetails.createClientDetails("319.001", "LAXMI FOODS", dFormat.parse("2019-06-04"), dFormat.parse("2023-06-05")));//Renewed on 6-7-2021 for 1 year till 4-6-2022//Renewed on 15-01-2021 for 1 year till 19-01-2022 // Released on 07-08-2019 for 1 year till 03-06-2020
			hmClientDtl.put("320.001", clsClientDetails.createClientDetails("320.001", "HOTEL SURYA", dFormat.parse("2021-10-01"), dFormat.parse("2022-09-31")));//Renewed on 02-04-2021 for 6 month till 30-09-2021//Renewed on 08-11-2020 for 6 month till 31-03-2021//Renewed on 30-07-2020 for 1 week//Renewed on 08-11-2019 for one month till 2019-12-15//Renewed on 15-10-2019 for one month till 2019-11-15  //Renewed on 05-10-2019 till 17-10-19//Released on 24-07-2019 for 1 month till 23-08-2019//Released on 16-06-2019 for 1 week till 23-07-2019// Released on 13-06-2019 for 1 month till 15-07-2019
			hmClientDtl.put("322.001", clsClientDetails.createClientDetails("322.001", "BREWSMITH HOSPITALITY PVT LTD", dFormat.parse("2019-07-12"), dFormat.parse("2021-09-30"))); //Released for 1 year till 11-07-2020// Released on 12-07-2019 for 1 month till 12-08-2019
			...
			hmClientDtl.put("341.001", clsClientDetails.createClientDetails("341.001", "THE FLOUR WORKS", dFormat.parse("2019-12-01"), dFormat.parse("2022-08-01")));//(Mumbai)//Renewed for 1 month on 6-7-2021//Released on 09-12-2019 for 1 year till 09-12-2020
