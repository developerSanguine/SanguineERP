...
public class clsRecipeMasterBean {
	...
	private String dblYieldPer;
	
	private String strReplaceChildCode;
	
	private String strRecipeSelected;

	
	private List<clsBomDtlModel> listBomDtlModel;
	
	private List<clsRecipeMasterBean> listReplaceProduct;
	...
	public String getDblYieldPer() {
		return dblYieldPer;
	}

	public void setDblYieldPer(String dblYieldPer) {
		this.dblYieldPer = dblYieldPer;
	}

	public List<clsRecipeMasterBean> getListReplaceProduct() {
		return listReplaceProduct;
	}

	public void setListReplaceProduct(List<clsRecipeMasterBean> listReplaceProduct) {
		this.listReplaceProduct = listReplaceProduct;
	}

	public String getStrReplaceChildCode() {
		return strReplaceChildCode;
	}

	public void setStrReplaceChildCode(String strReplaceChildCode) {
		this.strReplaceChildCode = strReplaceChildCode;
	}

	public String getStrRecipeSelected() {
		return strRecipeSelected;
	}

	public void setStrRecipeSelected(String strRecipeSelected) {
		this.strRecipeSelected = strRecipeSelected;
	}
