...
public class clsProductMasterBean {
	...
	private String strProdChildCode ;  
	
	private String strProdChildName ;  
	...
	public String getStrProdChildCode() {
		return strProdChildCode;
	}

	public String getStrProdChildName() {
		return strProdChildName;
	}

	public void setStrProdChildName(String strProdChildName) {
		this.strProdChildName = strProdChildName;
	}

	public void setStrProdChildCode(String strProdChildCode) {
		this.strProdChildCode = strProdChildCode;
	}
