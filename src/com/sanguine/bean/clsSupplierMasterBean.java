...
public class clsSupplierMasterBean {
	...
	private List<clsProdSuppMasterModel> listAllProd;
	...
	public List<clsProdSuppMasterModel> getListAllProd() {
		return listAllProd;
	}

	public void setListAllProd(List<clsProdSuppMasterModel> listAllProd) {
		this.listAllProd = listAllProd;
	}
