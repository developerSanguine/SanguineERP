...
public class clsLocationMasterBean {
	...
	private String strLocCode1;
	private String strLocName1;
	
	public String getStrLocCode1() {
		return strLocCode1;
	}

	public void setStrLocCode1(String strLocCode1) {
		this.strLocCode1 = strLocCode1;
	}

	public String getStrLocName1() {
		return strLocName1;
	}

	public void setStrLocName1(String strLocName1) {
		this.strLocName1 = strLocName1;
	}
	...
	private List<clsLocCustMasterModel> listLocCust;
	private String strUnderLocCode;
	private List<clsLocCustMasterModel> listLocSupp;
	...
	public List<clsLocCustMasterModel> getListLocCust() {
		return listLocCust;
	}

	public void setListLocCust(List<clsLocCustMasterModel> listLocCust) {
		this.listLocCust = listLocCust;
	}

	public List<clsLocCustMasterModel> getListLocSupp() {
		return listLocSupp;
	}

	public void setListLocSupp(List<clsLocCustMasterModel> listLocSupp) {
		this.listLocSupp = listLocSupp;
	}
