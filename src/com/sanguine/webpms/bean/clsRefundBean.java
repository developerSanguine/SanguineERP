...
public class clsRefundBean {
	...
	public String getDteRefundDate() {
		return dteRefundDate;
	}

	public void setDteRefundDate(String dteRefundDate) {
		this.dteRefundDate = dteRefundDate;
	}
