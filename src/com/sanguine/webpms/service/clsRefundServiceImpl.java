...
public class clsRefundServiceImpl implements clsRefundService {
	...
	public clsPMSPaymentHdModel funPrepareRefundModel(clsRefundBean objRefundBean, String clientCode, HttpServletRequest request, String userCode) {
		...
		String PMSDate= objRefundBean.getDteRefundDate();
		String[] splitDate = PMSDate.split("-");
		String RefundDate = splitDate[2] + "-" + splitDate[1] + "-" + splitDate[0];
		...
		objModel.setDteReceiptDate( objGlobal.funGetDate("yyyy-MM-dd",objRefundBean.getDteRefundDate()));
