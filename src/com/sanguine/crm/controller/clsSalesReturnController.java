...
//			}
	...
	public @ResponseBody clsSalesReturnBean funAssignFields(@RequestParam("srCode") String srCode, HttpServletRequest req) {
		...
		if(objDC!=null)
		{
			...
			for (int i = 0; i < objInvDtlModelList.size(); i++) {
				...
				//salesRetDtl.setDblPrice(salesRetDtl.getDblPrice());
				...
				salesRetDtl.setDblUnitPrice(salesRetDtl.getDblUnitPrice());
				//salesRetDtl.setDblUnitPrice(Double.valueOf(obj[8].toString()));
	...
	public List<Object> funGetSalesReturnDtl(String srCode, String clientCode) {
		...
		String sql = "  select a.strSRCode,a.strProdCode,a.dblQty,a.dblPrice,a.dblWeight,a.strRemarks,a.strClientCode,b.strProdName,(a.dblPrice/a.dblQty) dblUnitPrice " + " from tblsalesreturndtl a,tblproductmaster b ,tblsalesreturnhd c  " + " where a.strSRCode='" + srCode + "' and a.strProdCode= b.strProdCode and a.strSRCode=c.strSRCode " + " and a.strClientCode='" + clientCode + "' and b.strClientCode='" + clientCode + "' ";
	...
	public void funCallReportFormat2(clsReportBean objBean,String currencyCode, HttpServletResponse resp, HttpServletRequest req) {
		...
		try {
			...
			*/
			...
			String sql = " select b.strProdCode, c.strProdName, b.dblQty, b.dblUnitPrice as dblPrice,"
					+ " (b.dblQty*b.dblUnitPrice) as dblTotalAmt, b.strRemarks,"
