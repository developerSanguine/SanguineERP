...
public class clsSetupMasterController {
	...
	String funOpenSetupForm(
		...
		model.addAttribute("listLocation", mapLocation);
	...
	private void funSetPropertyData(clsPropertySetupModel objSetup,
		...
		bean.setStrPOMsgContent(objSetup.getStrPOMsgContent());
		bean.setStrGRNMsgContent(objSetup.getStrGRNMsgContent());
		bean.setStrInvoiceMsgContent(objSetup.getStrInvoiceMsgContent());
		bean.setStrAuthMsgContent(objSetup.getStrAuthMsgContent());
		...
		bean.setStrShowLocationWiseCustomer(objSetup.getStrShowLocationWiseCustomer());
		bean.setStrSendPOMsg(objSetup.getStrSendPOMsg());
		bean.setStrSendGRNMsg(objSetup.getStrSendGRNMsg());
		bean.setStrSendInvoiceMsg(objSetup.getStrSendInvoiceMsg());
		bean.setStrSendAuthMsg(objSetup.getStrSendAuthMsg());
	...
	private clsPropertySetupModel funPrepareMaster(clsSetupMasterBean bean,
		...
		objPropertySetupModel.setStrPOMsgContent(bean.getStrPOMsgContent());
		objPropertySetupModel.setStrGRNMsgContent(bean.getStrGRNMsgContent());
		objPropertySetupModel.setStrInvoiceMsgContent(bean.getStrInvoiceMsgContent());
		objPropertySetupModel.setStrAuthMsgContent(bean.getStrAuthMsgContent());
		...
		objPropertySetupModel.setStrShowLocationWiseCustomer(objGlobal.funIfNull(bean.getStrShowLocationWiseCustomer(), "N", bean.getStrShowLocationWiseCustomer()));
		objPropertySetupModel.setStrSendPOMsg(objGlobal.funIfNull(bean.getStrSendPOMsg(),"N",bean.getStrSendPOMsg()));
		objPropertySetupModel.setStrSendGRNMsg(objGlobal.funIfNull(bean.getStrSendGRNMsg(),"N",bean.getStrSendGRNMsg()));
		objPropertySetupModel.setStrSendInvoiceMsg(objGlobal.funIfNull(bean.getStrSendInvoiceMsg(),"N",bean.getStrSendInvoiceMsg()));
		objPropertySetupModel.setStrSendAuthMsg(objGlobal.funIfNull(bean.getStrSendAuthMsg(),"N",bean.getStrSendAuthMsg()));
	...
	*/
	...
	@RequestMapping(value = "/LoadWorkflowforSlabBasedAuth", method = RequestMethod.GET)
