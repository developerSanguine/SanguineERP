...
//					}
			...
			if (objBean.getStrReportType().equals("POS") && objBean.getStrReportView().equalsIgnoreCase("List")) {
				...
				sqlDtlQuery = " SELECT b.strProdCode,b.strRemark,c.strProdName, c.strProdType,  " + " SUM(b.dblQty),c.strUOM,b.strType,  b.dblRate,b.strDisplayQty,SUM(b.dblQty)*b.dblRate  " + "  FROM tblstockadjustmenthd a,tblstockadjustmentdtl b, tblproductmaster c   " + "   WHERE a.strSACode=b.strSACode  and Date(a.dtSADate) between '" + dtFDate + "' and '" + dtTDate + "'  "
