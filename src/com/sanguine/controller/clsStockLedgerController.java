...
public class clsStockLedgerController {
	...
	private ModelAndView funOpenStockLedger(@ModelAttribute("command") clsStockFlashBean objPropBean, BindingResult result, HttpServletRequest req) {
		req.getSession().setAttribute("formName", "frmStockLedger");
...
// check opening stock entry	
		...
		if (qtyWithUOM.equals("No")) {
			...
			//sql += "(select DATE_FORMAT(date(TransDate),'%d-%m-%Y'),TransType,RefNo,Receipt,Issue,Name,Rate,0 from ( ";
			sql += "select a.dtMISDate TransDate,2 TransNo, 'MIS In' TransType, a.strMISCode RefNo, (ifnull(sum(b.dblQty),0) * dblChildProdCF) /d.dblGroupProdCF  Receipt, 0 Issue " + ",c.strLocName Name ,b.dblUnitPrice Rate,0 " 
			+ "from tblmishd a, tblmisdtl b ,tbllocationmaster c ,tblproductmaster d" + " where a.strMISCode = b.strMISCode and a.strLocTo=c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocTo = '" + locCode + "' ";
			}
			if (null != hmAuthorisedForms.get("frmMIS")) {
			...
			+ " group by  d.strProdCode,a.dtMISDate,a.strMISCode,a.strLocTo " + ""

			+ "union all "

			+ "select a.dtCreatedDate TransDate,1 TransNo, 'Opening Stk' TransType, a.strOpStkCode RefNo, (ifnull(sum(b.dblQty),0) * c.dblChildProdCF) /c.dblGroupProdCF Receipt, 0 Issue" + ",'Opening Stock' Name,dblCostPerUnit Rate " 
			+ ",0 from tblinitialinventory a, tblinitialinvdtl b, tblproductmaster c " + "where a.strOpStkCode  = b.strOpStkCode " 
			+ "and b.strProdCode=c.strProdCode  AND c.strProdGroupCode = '" + prodCode + "' and c.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode='" + locCode + "' ";
			}
			sql += " and date(a.dtCreatedDate) >= '" + startDate + "' and date(a.dtCreatedDate) <= '" + toDate + "'  " 
			+ "group by  c.strProdCode, a.dtCreatedDate "

			+ "union all "

			+ "select a.dtGRNDate TransDate,3 TransNo, 'GRN' TransType, a.strGRNCode RefNo, (ifnull(sum(b.dblQty + b.dblFreeQty - b.dblRejected),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, 0 Issue" + ",c.strPName Name,b.dblUnitPrice Rate " 
			+ ",0 from tblgrnhd a, tblgrndtl b,tblpartymaster c ,tblproductmaster d " + "where a.strGRNCode = b.strGRNCode and a.strSuppCode=c.strPCode "
		    + "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode='" + locCode + "' ";
			}
			...
			+ "group by d.strProdCode,a.dtGRNDate , a.strGRNCode, a.strSuppCode, RefNo "

			+ "union all "

			+ "select a.dtSADate TransDate,11 TransNo, 'StkAdj In' TransType, a.strSACode RefNo, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, 0 Issue" + ",c.strLocName Name, b.dblRate Rate " 
			+ ",0 from tblstockadjustmenthd a, tblstockadjustmentdtl b,tbllocationmaster c ,tblproductmaster d " + "where a.strSACode = b.strSACode and a.strLocCode=c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' "
			+ "and b.strType='IN' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode='" + locCode + "' ";
			...
			+ "group by d.strProdCode,a.dtSADate, a.strSACode, a.strLocCode " + ""

			+ "union all "

			+ "select a.dtSTDate TransDate,4 TransNo, 'StkTrans In' TransType, a.strSTCode RefNo, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, 0 Issue" + ",c.strLocName Name,(b.dblTotalPrice/ifnull(sum(b.dblQty),1)) Rate " 
			+ ",0 from tblstocktransferhd a, tblstocktransferdtl b ,tbllocationmaster c ,tblproductmaster d  " + "where a.strSTCode  = b.strSTCode and a.strToLocCode = c.strLocCode "
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strToLocCode='" + locCode + "' ";
			}
			...
			+ "group by d.strProdCode,a.dtSTDate, a.strSTCode, a.strToLocCode " + ""

			+ "union all "

			+ "select a.dtMRetDate TransDate,5 TransNo, 'Mat Ret In' TransType, a.strMRetCode RefNo, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, 0 Issue" + ",c.strLocName Name,'1' Rate " 
			+ ",0 from tblmaterialreturnhd a, tblmaterialreturndtl b, tbllocationmaster c,tblproductmaster d " + "where a.strMRetCode  = b.strMRetCode and a.strLocTo=c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocTo='" + locCode + "' ";
			}
			...
			+ "group by d.strProdCode,a.dtMRetDate, a.strMRetCode, a.strLocTo " + ""

			+ "union all "

			+ "select a.dtPRDate TransDate,7 TransNo, 'Purchase Ret' TransType, a.strPRCode RefNo, 0 Receipt, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Issue" + ",c.strLocName Name,b.dblUnitPrice Rate " 
			+ ",0 from tblpurchasereturnhd a, tblpurchasereturndtl b,tbllocationmaster c ,tblproductmaster d " + "where a.strPRCode  = b.strPRCode and a.strLocCode=c.strLocCode "
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";;
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode='" + locCode + "' ";
			}
			...
			+ "group by d.strProdCode,a.dtPRDate,a.strPRCode,a.strLocCode  " + ""

			+ "union all "

			+ "select a.dtSADate TransDate,12 TransNo, IF(a.strNarration like '%Sales Data%','StkAdj Out (POS Consumption)','StkAdj Out (Phy Stock)')  TransType, a.strSACode RefNo, 0 Receipt, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Issue " + ",c.strLocName Name, b.dblRate Rate " 
			+ ",0 from tblstockadjustmenthd a, tblstockadjustmentdtl b,tbllocationmaster c,tblproductmaster d " + "where a.strSACode = b.strSACode and a.strLocCode=c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y'  " + "and b.strType='Out' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode='" + locCode + "' ";
			}
			if (null != hmAuthorisedForms.get("frmStockAdjustment")) {
			...
			+ "select a.dtSTDate TransDate,8 TransNo, 'StkTrans Out' TransType, a.strSTCode RefNo, 0 Receipt, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Issue " + ",c.strLocName Name,(b.dblPrice/ifnull(sum(b.dblQty),1)) Rate " 
			+ ",0 from tblstocktransferhd a, tblstocktransferdtl b ,tbllocationmaster c,tblproductmaster d " + "where a.strSTCode  = b.strSTCode and a.strFromLocCode = c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y'  ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strFromLocCode='" + locCode + "' ";
			}
			...
			sql += "and date(a.dtSTDate) >= '" + fromDate + "' and date(a.dtSTDate) <= '" + toDate + "' " 
			+ "group by d.strProdCode ,a.dtSTDate, a.strSTCode, a.strFromLocCode " + ""

			+ "union all "

			+ "select a.dtMRetDate TransDate,9 TransNo, 'Mat Ret Out' TransType, a.strMRetCode RefNo, 0 Receipt, (ifnull(sum(b.dblQty),0)  * d.dblChildProdCF) /d.dblGroupProdCF Issue " + ",c.strLocName Name,'1' Rate " 
			+ ",0 from tblmaterialreturnhd a, tblmaterialreturndtl b, tbllocationmaster c,tblproductmaster d " + "where a.strMRetCode  = b.strMRetCode and a.strLocFrom=c.strLocCode " 
			...
			sql += "and date(a.dtMRetDate) >= '" + fromDate + "' and date(a.dtMRetDate) <= '" + toDate + "' " 
			+ "group by d.strProdCode,a.dtMRetDate, a.strMRetCode, a.strLocFrom " + ""

			+ "union all "

			+ "select a.dtMISDate TransDate,10 TransNo, 'MIS Out' TransType, a.strMISCode RefNo, 0 Receipt, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Issue " + ",c.strLocName Name,b.dblUnitPrice Rate "
			+ ",0 from tblmishd a, tblmisdtl b, tbllocationmaster c ,tblproductmaster d " + "where a.strMISCode = b.strMISCode and a.strLocTo=c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y'  ";
			...
			+ "group by d.strProdCode,a.dtMISDate, a.strMISCode, a.strLocTo " + ""
				...
				+ " select a.dteSRDate TransDate,11 TransNo, 'Sales Ret' TransType, a.strSRCode RefNo, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, 0 Issue ,c.strLocName Name,d.dblCostRM Rate  " 
				+ " ,0 from tblsalesreturnhd a, tblsalesreturndtl b, tbllocationmaster c ,tblproductmaster d " 
				+ " where a.strSRCode = b.strSRCode and a.strLocCode=c.strLocCode "
				+ " and b.strProdCode=d.strProdCode and b.strProdCode=d.strProdCode  "
				+ " AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y'  ";

			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode = '" + locCode + "' ";
			}
			sql += " and date(a.dteSRDate) >= '" + fromDate + "' and date(a.dteSRDate) <= '" + toDate + "' " 
			+ "group by d.strProdCode ,a.dteSRDate, a.strSRCode, a.strLocCode " + ""
			...
			if (objSetup.getStrEffectOfInvoice().equalsIgnoreCase("Invoice")) {
				sql += "	 SELECT a.dteInvDate TransDate,13 TransNo, 'Invoice' TransType, a.strInvCode RefNo, 0 Receipt," + " (IFNULL(SUM(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Issue,c.strLocName Name,d.dblUnitPrice Rate,0 " + "  FROM tblinvoicehd a, tblinvoicedtl b, tbllocationmaster c,tblproductmaster d " + " where a.strInvCode=b.strInvCode AND a.strLocCode=c.strLocCode AND b.strProdCode=d.strProdCode AND "
						+ " b.strProdCode = '" + prodCode + "' ";
				if (!locCode.equalsIgnoreCase("All")) {
					sql += "and a.strLocCode = '" + locCode + "' ";
				}
				...
				sql += "	 SELECT a.dteDCDate TransDate,13 TransNo, 'Delivery Chal.' TransType, a.strDCCode RefNo, 0 Receipt," + " (IFNULL(SUM(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Issue,c.strLocName Name,d.dblUnitPrice Rate " 
				+ "  ,0 FROM tbldeliverychallanhd a, tbldeliverychallandtl b, tbllocationmaster c,tblproductmaster d "
						+ " where a.strDCCode=b.strDCCode AND a.strLocCode=c.strLocCode AND b.strProdCode=d.strProdCode  " 
						+ "  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y'  ";
				if (!locCode.equalsIgnoreCase("All")) {
					sql += "and a.strLocCode = '" + locCode + "' ";
				}
				sql += " AND DATE(a.dteDCDate) >= '" + fromDate + "' " + " AND DATE(a.dteDCDate) <= '" 
				+ toDate + "'  GROUP BY d.strProdCode,a.dteDCDate, a.strDCCode, a.strLocCode ";
			}

			sql += "UNION ALL  ";
			sql += "select a.dteSRDate TransDate,14 TransNo, 'SC GRN' TransType, a.strSRCode RefNo,( IFNULL(SUM(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, " + "0 Issue,c.strLocName Name,b.dblPrice Rate " 
			+ " ,0 from tblscreturnhd a,tblscreturndtl b ,tbllocationmaster c,tblproductmaster d  " 
			+ "where a.strSRCode=b.strSRCode and a.strLocCode=c.strLocCode AND b.strProdCode=d.strProdCode AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y'  ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode = '" + locCode + "' ";
			}
			sql += " AND DATE(a.dteSRDate) >= '" + fromDate + "' " + " AND DATE(a.dteSRDate) <= '" 
			+ toDate + "'  GROUP BY d.strProdCode,a.dteSRDate, a.strSRCode, a.strLocCode "

			+ " UNION ALL  ";

			sql += "select a.dteDNDate TransDate,15 TransNo, 'Delivery Note' TransType, a.strDNCode RefNo, 0 Receipt," + "( IFNULL(SUM(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF  Issue,c.strLocName Name,0 Rate " 
			+ " ,0 from tbldeliverynotehd a,tbldeliverynotedtl b ,tbllocationmaster c,tblproductmaster d 	"
			+ " where a.strDNCode=b.strDNCode and a.strLocCode=c.strLocCode  AND b.strProdCode=d.strProdCode AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";

			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode = '" + locCode + "' ";
			}
			sql += " AND DATE(a.dteDNDate) >= '" + fromDate + "' " + " AND DATE(a.dteDNDate) <= '"
			+ toDate + "'  GROUP BY d.strProdCode,a.dteDNDate, a.strDNCode, a.strLocCode ) a ";

			//sql += ") a " 
			sql+= "where date(TransDate) IS NOT NULL "
	...
	private List funCalculateStock(String prodCode, String locCode, String fromDate, String toDate, String qtyWithUOM, Map hmAuthorisedForms, String startDate, HttpServletRequest req, HttpServletResponse resp) {
		...
		if (qtyWithUOM.equals("No")) {
			...
			sql += "(select DATE_FORMAT(date(TransDate),'%d-%m-%Y'),TransType,RefNo,Receipt,Issue,Name,Rate from ( ";
			sql += "select a.dtMISDate TransDate,2 TransNo, 'MIS In' TransType, a.strMISCode RefNo, (ifnull(sum(b.dblQty),0) * dblChildProdCF) /d.dblGroupProdCF  Receipt, 0 Issue " + ",c.strLocName Name ,b.dblUnitPrice Rate " 
			+ "from tblmishd a, tblmisdtl b ,tbllocationmaster c ,tblproductmaster d" + " where a.strMISCode = b.strMISCode and a.strLocTo=c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocTo = '" + locCode + "' ";
			...
			+ "select a.dtCreatedDate TransDate,1 TransNo, 'Opening Stk' TransType, a.strOpStkCode RefNo, (ifnull(sum(b.dblQty),0) * c.dblChildProdCF) /c.dblGroupProdCF Receipt, 0 Issue" + ",'Opening Stock' Name,dblCostPerUnit Rate " 
			+ "from tblinitialinventory a, tblinitialinvdtl b, tblproductmaster c " + "where a.strOpStkCode  = b.strOpStkCode " 
			+ "and b.strProdCode=c.strProdCode  AND c.strProdGroupCode = '" + prodCode + "' and c.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode='" + locCode + "' ";
			}
			...
			+ "select a.dtGRNDate TransDate,3 TransNo, 'GRN' TransType, a.strGRNCode RefNo, (ifnull(sum(b.dblQty + b.dblFreeQty - b.dblRejected),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, 0 Issue" + ",c.strPName Name,b.dblUnitPrice Rate " 
			+ "from tblgrnhd a, tblgrndtl b,tblpartymaster c ,tblproductmaster d " + "where a.strGRNCode = b.strGRNCode and a.strSuppCode=c.strPCode "
		    + "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode='" + locCode + "' ";
			}
			...
			+ "select a.dtSADate TransDate,11 TransNo, 'StkAdj In' TransType, a.strSACode RefNo, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, 0 Issue" + ",c.strLocName Name, b.dblRate Rate " 
			+ "from tblstockadjustmenthd a, tblstockadjustmentdtl b,tbllocationmaster c ,tblproductmaster d " + "where a.strSACode = b.strSACode and a.strLocCode=c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' "
			+ "and b.strType='IN' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode='" + locCode + "' ";
			...
			+ "select a.dtSTDate TransDate,4 TransNo, 'StkTrans In' TransType, a.strSTCode RefNo, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, 0 Issue" + ",c.strLocName Name,(b.dblTotalPrice/ifnull(sum(b.dblQty),1)) Rate " 
			+ "from tblstocktransferhd a, tblstocktransferdtl b ,tbllocationmaster c ,tblproductmaster d  " + "where a.strSTCode  = b.strSTCode and a.strToLocCode = c.strLocCode "
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strToLocCode='" + locCode + "' ";
			}
			...
			+ "select a.dtMRetDate TransDate,5 TransNo, 'Mat Ret In' TransType, a.strMRetCode RefNo, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Receipt, 0 Issue" + ",c.strLocName Name,'1' Rate " 
			+ "from tblmaterialreturnhd a, tblmaterialreturndtl b, tbllocationmaster c,tblproductmaster d " + "where a.strMRetCode  = b.strMRetCode and a.strLocTo=c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocTo='" + locCode + "' ";
			}
			...
			+ "select a.dtPRDate TransDate,7 TransNo, 'Purchase Ret' TransType, a.strPRCode RefNo, 0 Receipt, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Issue" + ",c.strLocName Name,b.dblUnitPrice Rate " 
			+ "from tblpurchasereturnhd a, tblpurchasereturndtl b,tbllocationmaster c ,tblproductmaster d " + "where a.strPRCode  = b.strPRCode and a.strLocCode=c.strLocCode "
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y' ";;
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strLocCode='" + locCode + "' ";
			}
			...
			+ "select a.dtSTDate TransDate,8 TransNo, 'StkTrans Out' TransType, a.strSTCode RefNo, 0 Receipt, (ifnull(sum(b.dblQty),0) * d.dblChildProdCF) /d.dblGroupProdCF Issue " + ",c.strLocName Name,(b.dblPrice/ifnull(sum(b.dblQty),1)) Rate " 
			+ "from tblstocktransferhd a, tblstocktransferdtl b ,tbllocationmaster c,tblproductmaster d " + "where a.strSTCode  = b.strSTCode and a.strFromLocCode = c.strLocCode " 
			+ "and b.strProdCode=d.strProdCode  AND d.strProdGroupCode = '" + prodCode + "' and d.strProdGroupYN = 'Y'  ";
			if (!locCode.equalsIgnoreCase("All")) {
				sql += "and a.strFromLocCode='" + locCode + "' ";
			}
			...
			+ "select a.dtMRetDate TransDate,9 TransNo, 'Mat Ret Out' TransType, a.strMRetCode RefNo, 0 Receipt, (ifnull(sum(b.dblQty),0)  * d.dblChildProdCF) /d.dblGroupProdCF Issue " + ",c.strLocName Name,'1' Rate " 
			+ "from tblmaterialreturnhd a, tblmaterialreturndtl b, tbllocationmaster c,tblproductmaster d " + "where a.strMRetCode  = b.strMRetCode and a.strLocFrom=c.strLocCode " 
			...
			sql += " AND DATE(a.dteDNDate) >= '" + fromDate + "' " + " AND DATE(a.dteDNDate) <= '"
			+ toDate + "'  GROUP BY d.strProdCode,a.dteDNDate, a.strDNCode, a.strLocCode ";
