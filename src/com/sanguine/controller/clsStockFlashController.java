...
public class clsStockFlashController {
	...
	private ModelAndView funLoadPropertySelection(@ModelAttribute("command") clsStockFlashBean objPropBean, BindingResult result, HttpServletRequest req, Map<String, Object> model) {
		...
		req.getSession().setAttribute("formName", "frmStockFlash"); 
	...
	String clientCode = req.getSession().getAttribute("clientCode").toString();
		...
		@SuppressWarnings({ "unchecked", "rawtypes" })
		@RequestMapping(value = "/frmStockFlashDetailWithValueReport", method = RequestMethod.GET)
		private @ResponseBody List funShowStockDetaiWithValuelFlash(@RequestParam(value = "param1") String param1, @RequestParam(value = "fDate") String fDate, @RequestParam(value = "tDate") String tDate, @RequestParam(value = "prodType") String prodType, @RequestParam(value = "ManufCode") String strManufactureCode,@RequestParam(value = "prodClass") String prodClass, HttpServletRequest req, HttpServletResponse resp) {	
		String clientCode = req.getSession().getAttribute("clientCode").toString();
			String userCode = req.getSession().getAttribute("usercode").toString();
			String propertyCode = req.getSession().getAttribute("propertyCode").toString();
			String[] spParam1 = param1.split(",");
			...
			objGlobal.funInvokeStockFlash1(startDate, locCode, fromDate, toDate, clientCode, userCode, stockableItem, req, resp);
			String sql = "";
			...
			if (qtyWithUOM.equals("No")) {
				sql = "select f.strPropertyName,a.strProdCode,b.strProdName,e.strLocName" + ",d.strGName,c.strSGName,b.strUOM,b.strBinNo " + " ,if(ifnull(g.dblPrice,0)=0,b.dblCostRM,g.dblPrice) " + ",a.dblOpeningStk,a.dblGRN,dblGRNValue,a.dblFreeQty,a.dblSCGRN,dblSCGRNValue" + ",a.dblStkTransIn,a.dblStkTransInValue,a.dblStkAdjIn,a.dblMISIn,dblMISInValue,a.dblQtyProduced,dblQtyProducedValue" + ",a.dblSalesReturn,dblSalesReturnValue,a.dblMaterialReturnIn,dblMaterialReturnInValue,a.dblPurchaseReturn,dblPurchaseReturnValue"
						+ ",a.dblDeliveryNote,dblDeliveryNoteValue,a.dblStkTransOut,dblStkTransOutValue,a.dblStkAdjOut,dblStkAdjOutValue,a.dblMISOut,dblMISOutValue" + ",a.dblQtyConsumed,dblQtyConsumedValue,a.dblSales,dblSalesValue,a.dblMaterialReturnOut ,dblMaterialReturnOutValue" + ",a.dblClosingStk," + "((a.dblClosingStk)*if(ifnull(g.dblPrice,0)=0,b.dblCostRM,g.dblPrice)) as Value"
				...
				sql = "select f.strPropertyName,a.strProdCode,b.strProdName,e.strLocName" + " ,d.strGName,c.strSGName,b.strUOM,b.strBinNo"
						...
						+ " ,funGetUOM(a.dblGRN,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblGRNValue"
						
	                    + " ,funGetUOM(a.dblFreeQty,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM)"

						+ " ,funGetUOM(a.dblSCGRN,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblSCGRNValue"

						+ " ,funGetUOM(a.dblStkTransIn,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblStkTransInValue"

						+ " ,funGetUOM(a.dblStkAdjIn,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM)"

						+ " ,funGetUOM(a.dblMISIn,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblMISInValue"

						+ " ,funGetUOM(a.dblQtyProduced,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblQtyProducedValue"

						+ " ,funGetUOM(a.dblSalesReturn,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblSalesReturnValue"

						+ " ,funGetUOM(a.dblMaterialReturnIn,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblMaterialReturnInValue"

						+ " ,funGetUOM(a.dblPurchaseReturn,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblPurchaseReturnValue"

						+ " ,funGetUOM(a.dblDeliveryNote,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblDeliveryNoteValue"

						+ " ,funGetUOM(a.dblStkTransOut,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),dblStkTransOutValue"

						+ " ,funGetUOM(a.dblStkAdjOut,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblStkAdjOutValue"

						+ " ,funGetUOM(a.dblMISOut,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblMISOutValue"

						+ " ,funGetUOM(a.dblQtyConsumed,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblQtyConsumedValue"

						+ " ,funGetUOM(a.dblSales,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblSalesValue"

						+ " ,funGetUOM(a.dblMaterialReturnOut,b.dblRecipeConversion,b.dblIssueConversion,b.strReceivedUOM,b.strRecipeUOM),a.dblMaterialReturnOutValue"
			...
			for (int cnt = 0; cnt < list.size(); cnt++) {
				...
				objStkFlashModel.setDblGRN(funGetDecimalValue(arrObj[10].toString())); // GRN
				objStkFlashModel.setDblGRNValue(Double.parseDouble(arrObj[11].toString()));
				objStkFlashModel.setDblFreeQty(funGetDecimalValue(arrObj[12].toString()));
				objStkFlashModel.setDblSCGRN(funGetDecimalValue(arrObj[13].toString())); // SCGRN
				objStkFlashModel.setDblSCGRNValue(Double.parseDouble(arrObj[14].toString()));
				objStkFlashModel.setDblStkTransIn(funGetDecimalValue(arrObj[15].toString())); // stkTrans
				objStkFlashModel.setDblStkTransInValue(Double.parseDouble(arrObj[16].toString()));
				objStkFlashModel.setDblStkAdjIn(funGetDecimalValue(arrObj[17].toString())); // STKAdj
				
				objStkFlashModel.setDblMISIn(funGetDecimalValue(arrObj[18].toString()));//MIS
				objStkFlashModel.setDblMISInValue(Double.parseDouble(arrObj[19].toString()));
				objStkFlashModel.setDblQtyProduced(funGetDecimalValue(arrObj[20].toString()));//Qty Produced
				objStkFlashModel.setDblQtyProducedValue(Double.parseDouble(arrObj[21].toString()));
				
				objStkFlashModel.setDblSalesReturn(funGetDecimalValue(arrObj[22].toString()));//Sales Return
				objStkFlashModel.setDblSalesReturnValue(Double.parseDouble(arrObj[23].toString()));
				objStkFlashModel.setDblMaterialReturnIn(funGetDecimalValue(arrObj[24].toString()));//Material return
				objStkFlashModel.setDblMaterialReturnInValue(Double.parseDouble(arrObj[25].toString()));
				objStkFlashModel.setDblPurchaseReturn(funGetDecimalValue(arrObj[26].toString()));//Purchase Return
				objStkFlashModel.setDblPurchaseReturnValue(Double.parseDouble(arrObj[27].toString()));
				objStkFlashModel.setDblDeliveryNote(funGetDecimalValue(arrObj[28].toString()));//Delivery Note
				objStkFlashModel.setDblDeliveryNoteValue(Double.parseDouble(arrObj[29].toString()));
				objStkFlashModel.setDblStkTransOut(funGetDecimalValue(arrObj[30].toString()));//Stk Out
				objStkFlashModel.setDblStkTransOutValue(Double.parseDouble(arrObj[31].toString()));
				objStkFlashModel.setDblStkAdjOut(funGetDecimalValue(arrObj[32].toString()));//Stk Adj
				objStkFlashModel.setDblStkAdjOutValue(Double.parseDouble(arrObj[33].toString()));
				objStkFlashModel.setDblMISOut(funGetDecimalValue(arrObj[34].toString()));//MIS Out
				objStkFlashModel.setDblMISOutValue(Double.parseDouble(arrObj[35].toString()));
				objStkFlashModel.setDblQtyConsumed(funGetDecimalValue(arrObj[36].toString()));//Qty Consumed
				objStkFlashModel.setDblQtyConsumedValue(Double.parseDouble(arrObj[37].toString()));
				objStkFlashModel.setDblSales(funGetDecimalValue(arrObj[38].toString()));//Sales
				objStkFlashModel.setDblSalesValue(Double.parseDouble(arrObj[39].toString()));
				objStkFlashModel.setDblMaterialReturnOut(arrObj[40].toString());//Material Return
				objStkFlashModel.setDblMaterialReturnOutValue(Double.parseDouble(arrObj[41].toString()));
				
				double dblCurrStk = 0.0;
				
				
				objStkFlashModel.setDblClosingStock(funGetDecimalValue(arrObj[42].toString()));
				try{
					if (qtyWithUOM.equals("No")) {
						if(arrObj[6].toString().equalsIgnoreCase("NOS")){
							objStkFlashModel.setDblClosingStock(String.valueOf(Math.round(Double.parseDouble(arrObj[42].toString())))); // openStk
						}	
					}else{
						if(arrObj[6].toString().equalsIgnoreCase("NOS")){
							objStkFlashModel.setDblClosingStock(funGetDecimalNOSValue(arrObj[42].toString())); // openStk
				...
				BigDecimal value = new BigDecimal(arrObj[43].toString());
				// double value=Double.parseDouble(arrObj[27].toString());
				if(ratePickUpFrom.equalsIgnoreCase("Last Supplier Rate")){
					if (qtyWithUOM.equals("No")) {
						value= new BigDecimal(objGRN.funGetLastGrnRate(arrObj[1].toString(),clientCode) * Double.parseDouble(arrObj[43].toString()));	
					}
				...
				objStkFlashModel.setDblValue(String.valueOf(value));
				objStkFlashModel.setDblIssueUOMStock(funGetDecimalValue(arrObj[44].toString()));
				objStkFlashModel.setDblIssueConversion(arrObj[45].toString());
				objStkFlashModel.setStrIssueUOM(arrObj[46].toString());
				objStkFlashModel.setStrPartNo(arrObj[47].toString());
