	...
	public ModelAndView funValidateProperty(@ModelAttribute("command") clsPropertySelectionBean propBean, BindingResult result, HttpServletRequest req, Map<String, Object> model) {
		...
		try {
			...
			if (null != objSetup) {
				...
				req.getSession().setAttribute("strBatchMethod", objSetup.getStrBatchMethod());
				req.getSession().setAttribute("strIsFIFO", objSetup.getStrFifo());
			...
			ex.printStackTrace();
			return new ModelAndView("frmStructureUpdate_2");//to check 90d problem
