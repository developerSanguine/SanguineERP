...
*/
	...
	private List funTransReportFlashQuery(String locCode, String fromDate, String toDate, String userCode) {
		...
		sql += " select 1 TransNo,count(a.strUserCreated) NoOfTranse , 'Opening Stk' TransType, b.strLocName Location, " + " a.strUserCreated username " + " from tblinitialinventory a,tbllocationmaster b " + "  where a.strLocCode = b.strLocCode   and date(a.dtCreatedDate) = '" + fromDate + "' ";
		...
		sql += " select 2 TransNo,count(a.strUserCreated) NoOfTranse , 'MIS Out' TransType, b.strLocName Location,a.strUserCreated username " + " from tblmishd a, tbllocationmaster b " + " where a.strLocFrom=b.strLocCode  and date(a.dtMISDate) >= '" + fromDate + "' and date(a.dtMISDate) <= '" + toDate + "' ";
		...
		sql += " select 3 TransNo,count(a.strUserCreated) NoOfTranse , 'MIS In' TransType, b.strLocName Location,a.strUserCreated username " + " from tblmishd a, tbllocationmaster b  " + " where   a.strLocTo=b.strLocCode and " + " date(a.dtMISDate) >= '" + fromDate + "' and date(a.dtMISDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
		...
		sql += " select 4 TransNo,count(a.strUserCreated) NoOfTranse , 'GRN' TransType, b.strLocName Location,a.strUserCreated username " + " from tblgrnhd a, tbllocationmaster b  " + " where  a.strLocCode=b.strLocCode and date(a.dtGRNDate) >= '" + fromDate + "' and date(a.dtGRNDate) <= '" + toDate + "'  ";
		if(!locCode.equalsIgnoreCase("All")){
	         sql += "and a.strLocCode='" + locCode + "' " ;
         }
		if (!userCode.equalsIgnoreCase("All")) {
		...
		sql += " select 5 TransNo,count(a.strUserCreated) NoOfTranse , 'StkAdj Out' TransType, c.strLocName Location," + " a.strUserCreated username from tblstockadjustmenthd a, tblstockadjustmentdtl b,tbllocationmaster c " + " where a.strSACode = b.strSACode  and a.strLocCode=c.strLocCode and b.strType='OUT' " + "  and date(a.dtSADate) >= '" + fromDate
		...
		sql += " select 6 TransNo,count(a.strUserCreated) NoOfTranse , 'Stock Transfer In' TransType, b.strLocName Location, " + "a.strUserCreated username " + " from tblstocktransferhd a, tbllocationmaster b " + "  where  a.strToLocCode = b.strLocCode  " + " and date(a.dtSTDate) >= '" + fromDate + "' and date(a.dtSTDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
		...
		sql += " select 7 TransNo,count(a.strUserCreated) NoOfTranse , 'Stock Transfer Out' TransType, b.strLocName Location," + " a.strUserCreated username from tblstocktransferhd a, tbllocationmaster b " + " where  a.strFromLocCode = b.strLocCode  and " + " date(a.dtSTDate) >= '" + fromDate + "' and date(a.dtSTDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
		...
		sql += " select 8 TransNo,count(a.strUserCreated) NoOfTranse , 'Material Return In' TransType, b.strLocName Location," + " a.strUserCreated username from tblmaterialreturnhd a, tbllocationmaster b " + " where a.strLocTo=b.strLocCode   " + " and date(a.dtMRetDate) >= '" + fromDate + "'  and date(a.dtMRetDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
	         sql += " and a.strLocTo='" + locCode + "'";
         }
		if (!userCode.equalsIgnoreCase("All")) {
		...
		sql += " select 9 TransNo,count(a.strUserCreated) NoOfTranse , 'Material Return Out' TransType, b.strLocName Location," + " a.strUserCreated username from tblmaterialreturnhd a, tbllocationmaster b " + " where a.strLocFrom=b.strLocCode   and " + " date(a.dtMRetDate) >= '" + fromDate + "' and date(a.dtMRetDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
	         sql += "and a.strLocFrom='" + locCode + "'";
         }
		if (!userCode.equalsIgnoreCase("All")) {
		...
		sql += " select 10 TransNo,count(a.strUserCreated) NoOfTranse , 'Production' TransType, b.strLocName Location," + " a.strUserCreated username from tblproductionhd a, tbllocationmaster b " + " where  a.strLocCode=b.strLocCode   " + " and date(a.dtPDDate) >= '" + fromDate + "' and date(a.dtPDDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
	         sql += " and a.strLocCode='" + locCode + "'";
         }
		if (!userCode.equalsIgnoreCase("All")) {
		...
		sql += " select 11 TransNo,count(a.strUserCreated) NoOfTranse , 'Purchase Return' TransType, b.strLocName Location," + " a.strUserCreated username from tblpurchasereturnhd a, tbllocationmaster b " + " where a.strLocCode=b.strLocCode  " + " and date(a.dtPRDate) >= '" + fromDate + "' and date(a.dtPRDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
	         sql += " and a.strLocCode='" + locCode + "'";
         }
		if (!userCode.equalsIgnoreCase("All")) {
		...
		sql += " select 12 TransNo,count(a.strUserCreated) NoOfTranse , 'Sales Ret' TransType, b.strLocName Location," + " a.strUserCreated username from tblsalesreturnhd a, tbllocationmaster b " + " where a.strLocCode=b.strLocCode  and " + " date(a.dteSRDate) >= '" + fromDate + "' and date(a.dteSRDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
	         sql += " and  a.strLocCode='" + locCode + "' " + "";
         }
		if (!userCode.equalsIgnoreCase("All")) {
		...
		sql += " select 13 TransNo,count(a.strUserCreated) NoOfTranse , 'Delivery challan' TransType, b.strLocName Location," + " a.strUserCreated username from tbldeliverychallanhd a, tbllocationmaster b " + " where a.strLocCode=b.strLocCode " + " and date(a.dteDCDate) >= '" + fromDate + "' and date(a.dteDCDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
	         sql += " and  a.strLocCode='" + locCode + "' " + "";
         }
		if (!userCode.equalsIgnoreCase("All")) {
		...
		sql += " select 14 TransNo,count(a.strUserCreated) NoOfTranse , 'Invoice' TransType, b.strLocName Location," + " a.strUserCreated username from tblinvoicehd  a, tbllocationmaster b " + " where a.strLocCode=b.strLocCode  " + " and date(a.dteInvDate) >= '" + fromDate + "' and date(a.dteInvDate) <= '" + toDate + "' ";
		if(!locCode.equalsIgnoreCase("All")){
	         sql += " and  a.strLocCode='" + locCode + "' " + "";
        }
		if (!userCode.equalsIgnoreCase("All")) {
