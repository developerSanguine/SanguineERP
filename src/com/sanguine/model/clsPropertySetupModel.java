...
public class clsPropertySetupModel extends clsBaseModel implements Serializable {
	...
	private String strSendPOMsg,strSendGRNMsg,strSendInvoiceMsg,strSendAuthMsg;
	private String strPOMsgContent,strGRNMsgContent,strInvoiceMsgContent,strAuthMsgContent;
	...
	@Column(name = "strShowLocationWiseCustomer", columnDefinition = "VARCHAR(1) default 'N'")
	private String strShowLocationWiseCustomer;
	...
	public String getStrShowLocationWiseCustomer() {
		return strShowLocationWiseCustomer;
	}

	public void setStrShowLocationWiseCustomer(String strShowLocationWiseCustomer) {
		this.strShowLocationWiseCustomer = strShowLocationWiseCustomer;
	}
	
	public String getStrSendPOMsg() {
		return strSendPOMsg;
	}

	public void setStrSendPOMsg(String strSendPOMsg) {
		this.strSendPOMsg = strSendPOMsg;
	}

	public String getStrSendGRNMsg() {
		return strSendGRNMsg;
	}

	public void setStrSendGRNMsg(String strSendGRNMsg) {
		this.strSendGRNMsg = strSendGRNMsg;
	}

	public String getStrSendInvoiceMsg() {
		return strSendInvoiceMsg;
	}

	public void setStrSendInvoiceMsg(String strSendInvoiceMsg) {
		this.strSendInvoiceMsg = strSendInvoiceMsg;
	}

	public String getStrSendAuthMsg() {
		return strSendAuthMsg;
	}

	public void setStrSendAuthMsg(String strSendAuthMsg) {
		this.strSendAuthMsg = strSendAuthMsg;
	}

	public String getStrPOMsgContent() {
		return strPOMsgContent;
	}

	public void setStrPOMsgContent(String strPOMsgContent) {
		this.strPOMsgContent = strPOMsgContent;
	}

	public String getStrGRNMsgContent() {
		return strGRNMsgContent;
	}

	public void setStrGRNMsgContent(String strGRNMsgContent) {
		this.strGRNMsgContent = strGRNMsgContent;
	}

	public String getStrInvoiceMsgContent() {
		return strInvoiceMsgContent;
	}

	public void setStrInvoiceMsgContent(String strInvoiceMsgContent) {
		this.strInvoiceMsgContent = strInvoiceMsgContent;
	}

	public String getStrAuthMsgContent() {
		return strAuthMsgContent;
	}

	public void setStrAuthMsgContent(String strAuthMsgContent) {
		this.strAuthMsgContent = strAuthMsgContent;
	}
