...
public class clsReasonMaster {
	...
	@Column(name = "strBillPassing")
	private String strBillPassing;
	
	
	

	public String getStrBillPassing() {
		return strBillPassing;
	}

	public void setStrBillPassing(String strBillPassing) {
		this.strBillPassing = strBillPassing;
	}
