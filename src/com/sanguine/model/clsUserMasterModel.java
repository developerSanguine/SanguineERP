...
public class clsUserMasterModel {
	...
	@Column(name = "strExpiryItemNotification")
	private String strExpiryItemNotification;
	
    @Column(name = "intExpiryItemDays")
    private long intExpiryItemDays;
...
@Column(name = "strEmail")
	...
	public String getStrExpiryItemNotification() {
		return strExpiryItemNotification;
	}

	public void setStrExpiryItemNotification(String strExpiryItemNotification) {
		this.strExpiryItemNotification = strExpiryItemNotification;
	}

	public long getIntExpiryItemDays() {
		return intExpiryItemDays;
	}

	public void setIntExpiryItemDays(long intExpiryItemDays) {
		this.intExpiryItemDays = intExpiryItemDays;
	}
