...
public class clsStkPostingHdModel implements Serializable {
	...
	@Column(name = "strProductMasterUpdateYN" ,columnDefinition = "VARCHAR(10)NOT NULL default ''")
	private String strProductMasterUpdateYN;
	...
	public String getStrProductMasterUpdateYN() {
		return strProductMasterUpdateYN;
	}

	public void setStrProductMasterUpdateYN(String strProductMasterUpdateYN) {
		this.strProductMasterUpdateYN = strProductMasterUpdateYN;
	}
