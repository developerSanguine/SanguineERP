...
public class clsRateContractDaoImpl implements clsRateContractDao {
	...
	public clsRateContractDtlModel funGetCostRM(String prodCode, String clientCode) {
		
			//return (clsRateContractDtlModel) sessionFactory.getCurrentSession().get(clsRateContractDtlModel.class, new clsRateContractDtlModel_ID(prodCode, clientCode));
		return  sessionFactory.getCurrentSession().get(clsRateContractDtlModel.class, prodCode);
