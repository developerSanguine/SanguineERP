...
//			;
		...
		sql=" CREATE TABLE `tblloccustmaster` ( "
			+ " `strCustCode` VARCHAR(10) NOT NULL COLLATE 'latin1_swedish_ci', "
	        + " `strLocCode` VARCHAR(10) NOT NULL COLLATE 'latin1_swedish_ci', "
	        + " `strClientCode` VARCHAR(10) NOT NULL COLLATE 'latin1_swedish_ci', "
	        + "`strCustName` VARCHAR(255) NULL DEFAULT NULL COLLATE 'latin1_swedish_ci', "
	        + "PRIMARY KEY (`strCustCode`, `strLocCode`, `strClientCode`) USING BTREE "
	        + " ) "
	        + " COLLATE='latin1_swedish_ci' "
	        + " ENGINE=InnoDB; ";
		funExecuteQuery(sql);
		
		sql=" ALTER TABLE `tblpropertysetup` ADD COLUMN `strShowLocationWiseCustomer` VARCHAR(1) NOT NULL DEFAULT 'N' AFTER `strOpenTaxCalculation`; ";
		funExecuteQuery(sql);
		
		//Shubhangi 06/05/22 Property Setup New Columns
		
		sql=" ALTER TABLE `tblpropertysetup` "
					+ " ADD COLUMN `strSendPOMsg` VARCHAR(10) NOT NULL DEFAULT 'N' COLLATE 'latin1_swedish_ci' AFTER `strShowLocationWiseCustomer`, "
					+ " ADD COLUMN `strSendGRNMsg` VARCHAR(10) NOT NULL DEFAULT 'N' COLLATE 'latin1_swedish_ci' AFTER `strSendPOMsg`, "
					+ " ADD COLUMN `strSendInvoiceMsg` VARCHAR(10) NOT NULL DEFAULT 'N' COLLATE 'latin1_swedish_ci' AFTER `strSendGRNMsg`, "
					+ " ADD COLUMN `strSendAuthMsg` VARCHAR(10) NOT NULL DEFAULT 'N' COLLATE 'latin1_swedish_ci' AFTER `strSendInvoiceMsg`, "
					+ " ADD COLUMN `strPOMsgContent` VARCHAR(300) NOT NULL DEFAULT '' COLLATE 'latin1_swedish_ci' AFTER `strSendAuthMsg`, "
					+ " ADD COLUMN `strGRNMsgContent` VARCHAR(300) NOT NULL DEFAULT '' COLLATE 'latin1_swedish_ci' AFTER`strPOMsgContent`, "
					+ " ADD COLUMN `strInvoiceMsgContent` VARCHAR(300) NOT NULL DEFAULT '' COLLATE 'latin1_swedish_ci' AFTER`strGRNMsgContent`, "
					+ " ADD COLUMN `strAuthMsgContent` VARCHAR(300) NOT NULL DEFAULT '' COLLATE 'latin1_swedish_ci' AFTER `strInvoiceMsgContent`;";
		funExecuteQuery(sql);
				
		sql=" ALTER TABLE `tbluserhd` "
					+ " ADD COLUMN `strMobileNo` VARCHAR(20) NOT NULL DEFAULT '' COLLATE 'latin1_swedish_ci' AFTER `intExpiryItemDays`;";
		funExecuteQuery(sql);	
		
		
		sql="ALTER TABLE `tblpurchaseorderdtl` ADD COLUMN `strGroupTaxCode`  VARCHAR(30) NOT NULL DEFAULT '' AFTER `dblAmount`;";
		funExecuteQuery(sql);
		
		sql="ALTER TABLE `tbltempitemstock` ADD COLUMN `dblValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblFreeQty`;";
		funExecuteQuery(sql);
		
		sql=" ALTER TABLE `tblcurrentstock` "
			+ " ADD COLUMN `dblGRNValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblFreeQty`, " 
			+ " ADD COLUMN `dblOpeningValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblGRNValue`, " 
			+ " ADD COLUMN `dblStkTransInValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblOpeningValue`, "
			+ " ADD COLUMN `dblMISInValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblTransInValue`, " 
			+ " ADD COLUMN `dblSalesReturnValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblMISInValue`, "
			+ " ADD COLUMN `dblMaterialReturnInValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblSalesReturnValue`, " 
			+ " ADD COLUMN `dblStkTransOutValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblMaterialReturnInValue`, "
			+ " ADD COLUMN `dblMISOutValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblStkTransOutValue`, " 
			+ " ADD COLUMN `dblMaterialReturnOutValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblMISOutValue`, "
			+ " ADD COLUMN `dblStkAdjOutValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblMaterialReturnOutValue`, "
			+ " ADD COLUMN `dblQtyProducedValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblStkAdjOutValue`, " 
			+ " ADD COLUMN `dblPurchaseReturnValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblQtyProducedValue`, "
			+ " ADD COLUMN `dblSCGRNValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblPurchaseReturnValue`, " 
			+ " ADD COLUMN `dblDeliveryNoteValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblSCGRNValue`, "
			+ " ADD COLUMN `dblSalesValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblDeliveryNoteValue`, "
			+ " ADD COLUMN `dblQtyConsumedValue` DECIMAL(18,4) NOT NULL DEFAULT '0.0000' AFTER `dblSalesValue`;";
		funExecuteQuery(sql);
		
		sql="ALTER TABLE `tbluserhd` "
				+ " ADD COLUMN `Column 21` VARCHAR(300) NOT NULL DEFAULT '' AFTER `dtLastModified`,"
				+ " ADD COLUMN `strExpiryItemNotification` VARCHAR(1) NOT NULL DEFAULT 'N' AFTER `strEmail`,"
				+ " ADD COLUMN `intExpiryItemDays` INT NOT NULL DEFAULT '0' AFTER `strExpiryItemNotification`;";
		funExecuteQuery(sql);
		sql = "CREATE TABLE `tblreportinggroup` ( "
			+ " `strReportGroupCode` VARCHAR(10) NOT NULL COLLATE 'utf8_general_ci',  "
			+ " `intRGId` INT(11) NOT NULL,  "
			+ " `strReportGroupName` VARCHAR(50) NOT NULL COLLATE 'utf8_general_ci',  "
			+ " `strPropertyCode` VARCHAR(10) NOT NULL COLLATE 'utf8_general_ci',  "
			+ " `strClientCode` VARCHAR(10) NOT NULL COLLATE 'utf8_general_ci',  "
			+ " PRIMARY KEY (`strReportGroupCode`, `strPropertyCode`, `strClientCode`) USING BTREE  "
			+ " )  "
			+ " COLLATE='latin1_swedish_ci'  "
			+ " ENGINE=InnoDB;";  
		funExecuteQuery(sql);
		
		sql="UPDATE `tbltreemast` SET `strFormDesc`='MIS MonthWise ProductWise Flash' WHERE  `strFormName`='frmMISMonthProdWiseStkFlash' AND `strModule`='1';";
		funExecuteQuery(sql);
		
		sql="ALTER TABLE `tblbommasterdtl` ADD COLUMN `dblYieldPer` DECIMAL(10,0) NOT NULL DEFAULT '100' AFTER `dblQtyConversion`;";
		funExecuteQuery(sql);
		
		/*sql="update tbltreemast set strAuditForm='Yes' where strRootNode='Master' and strModule=1;";
		funExecuteQuery(sql);*/
		
		sql="ALTER TABLE `tblproductmaster` "
			+ " ADD COLUMN `strProdGroupCode` VARCHAR(50) NULL DEFAULT '' AFTER `strHSNCode`, "
			+ " ADD COLUMN `strProdGroupYN` VARCHAR(50) NULL DEFAULT '' AFTER `strProdGroupCode`, "
			+ " ADD COLUMN `dblChildProdCF` DECIMAL(18,4) NOT NULL DEFAULT '0' AFTER `strProdGroupYN`, "
			+ " ADD COLUMN `dblGroupProdCF` DECIMAL(18,4) NOT NULL DEFAULT '0' AFTER `dblChildProdCF`;" ;
		funExecuteQuery(sql);
	...
	//				+ " ('frmExciseChallan', 'Excise Challan', 'Sales', 2, 'T', 57, 4, '1', 'default.png', '6', 1, '1', '1', 'NO', 'Yes', 'frmExciseChallan.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), "
					...
					+ " ('frmReportGroupMaster', 'Report Group Master', 'Master', '7', 'M', '186', '8', '1', 'default.png', '1', '1', '1', '1', 'NO', 'NO', 'frmReportGroupMaster.html',NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),"
			        + "	('frmCloseOpenPO', 'Close Open PO', 'Purchase', '3', 'T', '194', '109', '1', 'default.png', '1', '1', '1', '1', 'YES', 'YES', 'frmCloseOpenPO.html',NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL ),";
			...
			sql="INSERT INTO `tbltreemast` (`strFormName`, `strFormDesc`, `strRootNode`, `intRootIndex`, `strType`, `intFormKey`, `intFormNo`, `strImgSrc`, `strImgName`, `strModule`, `strTemp`, `strActFile`, `strHelpFile`, `strProcessForm`, `strAutorisationForm`, `strRequestMapping`, `strAdd`, `strAuthorise`, `strDelete`, `strDeliveryNote`, `strDirect`, `strEdit`, `strGRN`, `strGrant`, `strMinimumLevel`, `strOpeningStock`, `strPrint`, `strProductionOrder`, `strProject`, `strPurchaseIndent`, `strPurchaseOrder`, `strPurchaseReturn`, `strRateContractor`, `strRequisition`, `strSalesOrder`, `strSalesProjection`, `strSalesReturn`, `strServiceOrder`, `strSubContractorGRN`, `strView`, `strWorkOrder`, `strAuditForm`, `strMIS`, `strInvoice`, `strDeliverySchedule`, `strFormAccessYN`) VALUES "
			        ...
			        + " ('frmPurchaseReturnReport', 'Purchase Return Report', 'Purchases', 7, 'R', 54, 33, '1', 'default.png', '1', 1, '1', '1','NO','NO', 'frmPurchaseReturnReport.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y')," 
			        + " ('frmReplaceProduct', 'Replace Product', 'Master', '8', 'M', '4', '3', '2', 'default.png', '1', '1', '1','1', 'NO', 'YES', 'frmReplaceProduct.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y') ";
			funExecuteQuery(sql);
		...
		sql="ALTER TABLE `tblstockpostinghd` ADD COLUMN  `strProductMasterUpdateYN` VARCHAR(10) NOT NULL DEFAULT '' AFTER `strAuthLevel5`;";
		funExecuteQuery(sql);
		
		sql="ALTER TABLE `tblproductmaster` ADD COLUMN `strSGCCode` VARCHAR(50) NOT NULL DEFAULT '' AFTER `dblGroupProdCF`;";
		funExecuteQuery(sql);
		
		sql = "CREATE TABLE `tblsubgroupcategorymaster` ("
				+ "`strSGCCode` VARCHAR(10) NOT NULL,"
				+ "`intSGCId` INT(11) NOT NULL,"
				+ "`strSGCName` VARCHAR(50) NOT NULL,"
				+ "`strSGCDesc` VARCHAR(50) NOT NULL,"
				+ "`strSGCode` VARCHAR(10) NOT NULL,"
				+ "`strUserCreated` VARCHAR(10) NOT NULL,"
				+ "`dtCreatedDate` DATETIME NOT NULL,"
				+ "`strUserModified` VARCHAR(10) NOT NULL,"
				+ "`dtLastModified` DATETIME NOT NULL,"
				+ "`strClientCode` VARCHAR(255) NOT NULL,"
				+ "PRIMARY KEY (`strSGCCode`, `strClientCode`)"
				+ ")COLLATE='latin1_swedish_ci'"
				+ "ENGINE=InnoDB;";
...
//				+ " ('frmDebtorOutStandingList', 'Debtor OutStanding List', 'Reports', '6', 'R', '8', '8', '1', 'default.png', '5', '1', '1', '1', 'NO', 'NO', 'frmDebtorOutStandingList.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) ,"
		...
		sql="INSERT INTO `tbltreemast` (`strFormName`, `strFormDesc`, `strRootNode`, `intRootIndex`, `strType`, `intFormKey`, `intFormNo`, `strImgSrc`, `strImgName`, `strModule`, `strTemp`, `strActFile`, `strHelpFile`, `strProcessForm`, `strAutorisationForm`, `strRequestMapping`, `strAdd`, `strAuthorise`, `strDelete`, `strDeliveryNote`, `strDirect`, `strEdit`, `strGRN`, `strGrant`, `strMinimumLevel`, `strOpeningStock`, `strPrint`, `strProductionOrder`, `strProject`, `strPurchaseIndent`, `strPurchaseOrder`, `strPurchaseReturn`, `strRateContractor`, `strRequisition`, `strSalesOrder`, `strSalesProjection`, `strSalesReturn`, `strServiceOrder`, `strSubContractorGRN`, `strView`, `strWorkOrder`, `strAuditForm`, `strMIS`, `strInvoice`, `strDeliverySchedule`, `strFormAccessYN`) VALUES "
				+ " ('frmSubGroupCategoryMaster', 'Sub Group Category Master', 'Master', 8, 'M', 28, 14, '1', 'default.png', '1', 1, '1', '1', 'NO', 'YES', 'frmSubGroupCategoryMaster.html', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y')";
		funExecuteQuery(sql);
		
		
	/*   sql="INSERT INTO `tbltreemast` (`strFormName`, `strFormDesc`, `strRootNode`, `intRootIndex`, `strType`, `intFormKey`, `intFormNo`, `strImgSrc`, `strImgName`, `strModule`, `strTemp`, `strActFile`, `strHelpFile`, `strProcessForm`, `strAutorisationForm`, `strRequestMapping`,`strAdd`, `strAuthorise`, `strDelete`, `strDeliveryNote`, `strDirect`, `strEdit`, `strGRN`, `strGrant`, `strMinimumLevel`, `strOpeningStock`, `strPrint`, `strProductionOrder`, `strProject`, `strPurchaseIndent`, `strPurchaseOrder`, `strPurchaseReturn`, `strRateContractor`, `strRequisition`, `strSalesOrder`, `strSalesProjection`, `strSalesReturn`, `strServiceOrder`, `strSubContractorGRN`, `strView`, `strWorkOrder`, `strAuditForm`, `strMIS`, `strInvoice`, `strDeliverySchedule`, `strFormAccessYN`) VALUES "
			    + "	('frmCloseOpenPO', 'Close Open PO', 'Purchase', '3', 'T', '194', '109', '1', 'default.png', '1', '1', '1', '1', 'YES', 'YES', 'frmCloseOpenPO.html',NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Y')";	
		funExecuteQuery(sql);
	*/	
