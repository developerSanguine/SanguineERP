...
<script type="text/javascript">
		...
		$(document).ready(function() 
		{
			...
			$("#btnExecute").click(function( event )
			{
				...
				if($("#cmbReportType").val()=='Detail With Value')
				{
					document.getElementById("divValueTotal").style.visibility = "hidden"; 
					funCalculateStockFlashForDetailWithValue();
				}
		...
		function pageselectCallback(page_index, jq)
		{
		    ...
		    if($("#cmbReportType").val()=='Detail With Value')
		   	{	
		    	...
		    	if(clientCode=='211.001')
	    		{
	    		
		    		newcontent = '<table id="tblStockFlash" class="transTablex" style="width: 100%;font-size:11px;font-weight: bold;"><tr bgcolor="#c0c0c0"><td id="labld1" size="10%">Property Name</td><td id="labld2"> Product Code</td><td id="labld3"> Product Name</td>	<td id="labld4"> Location </td>	<td id="labld5"> Group</td><td id="labld6"> Sub Group</td><td id="labld7"> UOM</td><td id="labld8"> Weighted Avg Price</td><td id="labld9"> Opening Stock</td><td id="labld10"> GRN</td><td id="labld11"> GRN Value</td><td id="labld12"> Stock Transfer In</td><td id="labld13"> StockTransferIn Value</td><td id="labld14"> MIS In</td><td id="labld15"> MISIn Value</td><td id="labld16"> Material Return</td><td id="labld17"> Material Return Value</td><td id="labld18"> Purchase Return</td><td id="labld19">PurchaseReturn Value</td><td id="labld20"> Stock Trans Out</td><td id="labld21"> StockTransOut Value</td><td id="labld22"> MIS Out</td><td id="labld23"> MISOut Value</td><td id="labld24"> Qty Consumed</td><td id="labld25"> Qty Consumed Value</td><td id="labld26">Closing Stock</td><td id="labld27">Value</td></tr>';
				   	// Iterate through a selection of the content and build an HTML string
				    for(var i=page_index*items_per_page;i<max_elem;i++)
				    {
				        newcontent += '<tr><td>'+StkFlashData[i].strPropertyName+'</td>';
				       ...
				       // newcontent += '<td>'+StkFlashData[i].strBinNo+'</td>';
				         ...
				         if(qtyWithUOM=='No')
				        {
					        ...
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblFreeQty).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblGRN).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblGRNValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblSCGRN).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblSCGRNValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblStkTransIn).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblStkTransInValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblStkAdjIn).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblMISIn).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblMISInValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					       // newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblQtyProduced).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblQtyProducedValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					       // newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblSalesReturn).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblSalesReturnValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblMaterialReturnIn).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblMaterialReturnInValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblPurchaseReturn).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblPurchaseReturnValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					       // newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblDeliveryNote).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblDeliveryNoteValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblStkTransOut).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblStkTransOutValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblStkAdjOut).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblStkAdjOutValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblMISOut).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblMISOutValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblQtyConsumed).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblQtyConsumedValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					       
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblSales).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        //newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblSalesValue).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblClosingStock).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblValue/currValue).toFixed(maxAmountDecimalPlaceLimit) +'</td>';
					       // newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblIssueUOMStock).toFixed(maxQuantityDecimalPlaceLimit)+'</td>';
					       // newcontent += '<td align="right">'+StkFlashData[i].dblIssueConversion+'</td>';
					    ...
					    {				        
					        ...
					        newcontent += '<td align="right">'+StkFlashData[i].dblFreeQty+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblGRN+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblGRNValue+'</td>';
					       
					        newcontent += '<td align="right">'+StkFlashData[i].dblSCGRN+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblSCGRNValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblStkTransIn+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblStkTransInValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblStkAdjIn+'</td>';
					        
					        newcontent += '<td align="right">'+StkFlashData[i].dblMISIn+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblMISInValue+'</td>';
					        
					        newcontent += '<td align="right">'+StkFlashData[i].dblQtyProduced+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblQtyProducedValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblSalesReturn+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblSalesReturnValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblMaterialReturnIn+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblMaterialReturnInValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblPurchaseReturn+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblPurchaseReturnValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblDeliveryNote+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblDeliveryNoteValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblStkTransOut+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblStkTransOutValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblStkAdjOut+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblStkAdjOutValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblMISOut+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblMISOutValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblQtyConsumed+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblQtyConsumedValue+'</td>';
					       
					        newcontent += '<td align="right">'+StkFlashData[i].dblSales+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblSalesValue+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblClosingStock+'</td>';
					        newcontent += '<td align="right">'+parseFloat(StkFlashData[i].dblValue/currValue).toFixed(maxAmountDecimalPlaceLimit)+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblIssueUOMStock+'</td>';
					        newcontent += '<td align="right">'+StkFlashData[i].dblIssueConversion+'</td>';
	    		...
	    		newcontent = '<table id="tblStockFlash" class="transTablex" style="width: 100%;font-size:11px;font-weight: bold;"><tr bgcolor="#c0c0c0"><td id="labld1" size="10%">Property Name</td><td id="labld2"> Product Code</td><td id="labld3"> Product Name</td>	<td id="labld4"> Location </td>	<td id="labld5"> Group</td><td id="labld6"> Sub Group</td><td id="labld7"> UOM</td><td id="labld8"> Bin No</td><td id="labld9"> Weighted Avg Price</td><td id="labld10"> Opening Stock</td><td id="labld11"> Free Qty</td><td id="labld12"> GRN</td><td id="labld13"> GRN Value</td><td id="labld14"> SCGRN</td><td id="labld15"> SCGRN Value</td><td id="labld16"> Stock Transfer In</td><td id="labld17"> StockTransferIn Value</td><td id="labld18"> Stock Adj In</td><td id="labld19"> MIS In</td><td id="labld20"> MISIn Value</td><td id="labld21"> Qty Produced</td><td id="labld22"> Qty Produced Value</td><td id="labld23"> Sales Return</td><td id="labld24"> SalesReturn Value</td><td id="labld25"> Material Return</td><td id="labld26"> Material Return Value</td><td id="labld27"> Purchase Return</td><td id="labld28">PurchaseReturn Value</td><td id="labld29"> Delivery Note</td><td id="labld30"> DeliveryNote Value</td><td id="labld31"> Stock Trans Out</td><td id="labld32"> StockTransOut Value</td><td id="labld33"> Stock Adj Out</td><td id="labld34"> Stock AdjOut Value</td><td id="labld35"> MIS Out</td><td id="labld36"> MISOut Value</td><td id="labld37"> Qty Consumed</td><td id="labld38"> Qty Consumed Value</td><td id="labld39"> Sales</td><td id="labld40"> Sales Value</td><td id="labld41">Closing Stock</td><td id="labld42">Value</td><td id="labld43">Issue UOM Stock</td><td id="labld44">Issue Conversion</td><td id="labld45">Issue UOM </td><td id="labld46">Part No</td></tr>';
			   	// Iterate through a selection of the content and build an HTML string
			    for(var i=page_index*items_per_page;i<max_elem;i++)
			    {
			        newcontent += '<tr><td>'+StkFlashData[i].strPropertyName+'</td>';
		...
		function funCalculateStockFlashForDetailWithValue()
		{			
			var currValue='<%=session.getAttribute("currValue").toString()%>';
			var reportType=$("#cmbReportType").val();
			var fromDate=$("#txtFromDate").val();
			...
			var paramForStkLedger=locCode+","+propCode;		
			var manufCode=$("#txtManufacturerCode").val();
			var searchUrl=getContextPath()+"/frmStockFlashDetailWithValueReport.html?param1="+param1+"&fDate="+fromDate+"&tDate="+toDate+"&prodType="+prodType+"&ManufCode="+manufCode+"&prodClass="+prodClass;
			//alert(searchUrl);
			...
			$("#btnExport").click(function (e)
			{
				...
				if(reportType=='Summary' && strExportType=="PDF" )
					...
					window.location.href=getContextPath()+"/rptStockFlash.html?strExportType="+strExportType+"&prodType="+prodType+"&param1="+param1+"&ManufCode="+manufCode;
						...
						}else if( reportType=='Detail With Value')
						{
							if(clientCode=='211.001')
								{
								window.location.href=getContextPath()+"/downloadExcelForDetailWithValueForLimitedFields.html?param1="+param1+"&fDate="+fromDate+"&tDate="+toDate+"&prodType="+prodType+"&ManufCode="+manufCode;
								}
							else
								{
								window.location.href=getContextPath()+"/downloadExcelForDetailWithValue.html?param1="+param1+"&fDate="+fromDate+"&tDate="+toDate+"&prodType="+prodType+"&ManufCode="+manufCode;
								}
       ...
       function funAddReprtType()
		{
        	...
        	cSelectReport.add(new Option('Detail With Value'));
		...
		<div class="row transTable">
			...
			<div class="col-md-2">     
				 ...
				 <s:select path="strReportType" id="cmbReportType" cssClass="BoxW124px" onchange="funAddExportType();">
					...
					<option value="DetailWithValue">Detail With Value</option>
