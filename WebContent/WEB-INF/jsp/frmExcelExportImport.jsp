	...
	function funExport()
	{
		...
		switch(transactionformName)
		{
			...
			case "frmLocationMaster":
				...
				{
				window.location.href=getContextPath()+"/LocationMasterReorderLevelExcelExport.html?locCode="+LocCode+"&firstCount="+firstCount+"&secondCount="+secondCount;
				}
				break;
