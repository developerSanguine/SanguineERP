...
// 				}
		...
		function funSetData(code)
		{
			switch (fieldName) 
			{
			    ...
			    case 'taxmaster':
			    	...
			    	break;
			    case 'reason':
			    	document.getElementById("txtReasonCode."+reasonRowNo).value=code;
			    	break;
			}
		}
		...
		function funAddGRNRow()
		{
		   ...
		   var remarks=" ";
		    ...
		    row.insertCell(2).innerHTML= "<input size=\"18%\" name=\"listBillPassDtl["+(rowCount)+"].strChallanNo\" id=\"txtChallanNo."+(rowCount)+"\" value="+strChallanNo+">";
		    row.insertCell(3).innerHTML= "<input class=\"Box\" step=\"any\" required=\"required\" style=\"text-align: right;width:95%\" size=\"16%\"  name=\"listBillPassDtl["+(rowCount)+"].dblAdjustAmt\" id=\"txtAdjustAmt."+(rowCount)+"\" value="+dblAdjustAmt+">";
		    row.insertCell(4).innerHTML= "<input size=\"18%\" name=\"listBillPassDtl["+(rowCount)+"].strReasonCode\" id=\"txtReasonCode."+(rowCount)+"\"  onClick=funHelp1("+rowCount+",'reason') >";
		    row.insertCell(5).innerHTML= "<input size=\"35%\" name=\"listBillPassDtl["+(rowCount)+"].strRemarks\" id=\"txtRemarks."+(rowCount)+"\" value="+remarks+"  >";
		    row.insertCell(6).innerHTML= "<input class=\"Box\" size=\"12%\" style=\"text-align: right;\" name=\"listBillPassDtl["+(rowCount)+"].dblGRNAmt\" id=\"txtGRNAmt."+(rowCount)+"\" value="+value+">";
		    row.insertCell(7).innerHTML= '<input type="button" class="deletebutton" value = "Delete" onClick="Javacsript:funDeleteGRNRow(this)">';
...
<!-- 					<li data-state="tab2" style="width: 54px; padding-left: 37px">Tax</li> -->
				...
				<div id="tab1" class="tab_content" style="margin-top: 39px;">
					...
					<table style="height:20px;border:#0F0;font-size:11px;font-weight: bold;width:100%">
							<tr bgcolor="#c0c0c0">
								<td style="width: 15%; height: 16px;" align="left">Code</td>
								<td style="width: 15%; height: 16px;" align="left">Date</td>
								<td style="width: 12%; height: 16px;" align="left">Challan No</td>
								<td style="width: 10%; height: 16px;" align="left">Adjustment</td>
								<td style="width: 16%; height: 16px;" align="left">Reason</td>
								<td style="width: 22%; height: 16px;" align="left">Remarks</td>
								<td style="width: 6%; height: 16px;" align="left">Value</td>
								<td style="width: 6%; height: 16px;" align="center">Delete</td>
							</tr>
					</table>
