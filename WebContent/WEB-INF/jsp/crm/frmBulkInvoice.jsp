		...
		//Fill Supplier Data
		    ...
		    function funfillSOGrid(strSOCode,dteSODate,strCustName,dblSubTotal,strCustCode)
			{
				   ...
				   // name=\"listInvoiceTaxDtl["+(rowCount)+"].strTaxCode\"
				    ...
				    row.insertCell(1).innerHTML= "<input readonly=\"readonly\" class=\"Box \" name=\"listMultipleSOCodes["+(rowCount)+"].strSOCode\" size=\"16%\" id=\"strSOCode."+(rowCount)+"\" value='"+strSOCode+"' >";
				    row.insertCell(2).innerHTML= "<input readonly=\"readonly\" class=\"Box \" name=\"listMultipleSOCodes["+(rowCount)+"].dteSODate\" size=\"12%\" id=\"dteSODate."+(rowCount)+"\" value='"+dteSODate+"' >";
				    row.insertCell(3).innerHTML= "<input readonly=\"readonly\" class=\"Box \" name=\"listMultipleSOCodes["+(rowCount)+"].strCustName\" size=\"16%\" id=\"strCustName."+(rowCount)+"\" value='"+strCustName+"' >";
				    row.insertCell(4).innerHTML= "<input readonly=\"readonly\" class=\"Box \"  name=\"listMultipleSOCodes["+(rowCount)+"].dblSubTotalAmt\"  style=\"text-align: right;\" size=\"7%\" id=\"dblSubTotalAmt."+(rowCount)+"\" value='"+dblSubTotal+"' >";
							...
							<table id="" class="masterTable"
								...
								<tbody>
									<tr bgcolor="#c0c0c0">
										...
										<td width="15%">SO Code</td>
										<td width="15%">Fulfillment Date</td>
