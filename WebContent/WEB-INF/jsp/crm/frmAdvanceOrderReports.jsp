			 ...
			 **/
			 ...
			 var strGroupCode="";
				...
				if($("#cmbDocType").val()=="PDF")
		  		 {
				       //  window.open(getContextPath()+"/rptCategoryWiseSalesOrderReport.html");
					document.frmAdvanceOrderReports.action = "rptAdvOrderReport.html";
					document.frmAdvanceOrderReports.method = "POST";
				 }
			    else if($("#cmbDocType").val()=="40Col")
				 {
				        
			        		
       		     document.frmAdvanceOrderReports.action = "rptAdvOrderReport40Col.html";
				 document.frmAdvanceOrderReports.method = "POST";
				 }
...
<body>
     <div class="container transTable">
	    ...
	    <s:form name="frmAdvanceOrderReports" method="POST" action="" target="_blank" enctype="multipart/form-data">
			   ...
			   <div class="row">
			      ...
			      <div class="col-md-2" ><label>Report Type</label>
					<s:select id="cmbDocType" path="strDocType" style="width:70%;">
				    		...
				    		<s:option value="40Col">40Col</s:option>
