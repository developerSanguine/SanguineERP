	...
	<script type="text/javascript">
		...
		function funGetProdData1(response)
		{
            ...
            {	
				...
				response[i].strUnit,response[i].dblRate,response[i].strDiscountOn,response[i].dblDiscountPercent,response[i].dblDiscount,response[i].strNarration);
		...
		function funfillProdRow(strProdCode,strProdName,strPOSCode,strUOM,strRate,strDiscountOn,dblDiscountPercent,dblDiscount,strNarration)
		{
				var table = document.getElementById("tblProduct");
			    var rowCount = table.rows.length;
			    var row = table.insertRow(rowCount);
			    ...
			    row.insertCell(5).innerHTML= "<input readonly=\"readonly\" class=\"Box\" size=\"8%\"  name=\"listRateContDtl["+(rowCount)+"].strDiscountOn\" id=\"cmbDiscountOn."+(rowCount)+"\" value='"+strDiscountOn+"'/>";
			    row.insertCell(6).innerHTML= "<input type=\"text\"  required = \"required\" style=\"text-align: right;width:100%;border:1px solid #a2a2a2;\" size=\"4%\"class=\"decimal-places-amt\"  name=\"listRateContDtl["+(rowCount)+"].dblDiscountPercent\" id=\"txtDiscountOnMRP."+(rowCount)+"\" value='"+dblDiscountPercent.toFixed(maxAmountDecimalPlaceLimit)	+"' >";
			    row.insertCell(7).innerHTML= "<input type=\"text\"  required = \"required\" style=\"text-align: right;width:100%;border:1px solid #a2a2a2;\" size=\"4%\"class=\"decimal-places-amt\"  name=\"listRateContDtl["+(rowCount)+"].dblDiscount\" id=\"txtDiscount."+(rowCount)+"\" value='"+dblDiscount.toFixed(maxAmountDecimalPlaceLimit)	+"' >";
			    row.insertCell(8).innerHTML= "<input size=\"32%\" type=\"text\" style=\"border:1px solid #a2a2a2;\" name=\"listRateContDtl["+(rowCount)+"].strNarration\" id=\"txtNarrtion."+(rowCount)+"\" value='"+strNarration+"' >";
		...
		function funAddRow() 
		{
		    ...
		    var discountPercent = document.getElementById("txtDiscountOnMRP").value;
		    ...
		    row.insertCell(5).innerHTML= "<input type=\"text\"  required = \"required\" style=\"text-align: right;width:100%;border:1px solid a2a2a2;\" size=\"4%\"class=\"decimal-places-amt\"  name=\"listRateContDtl["+(rowCount)+"].strDiscountOn\" id=\"cmbDiscountOn."+(rowCount)+"\" value='"+discOn+"' >";
		    row.insertCell(6).innerHTML= "<input type=\"text\"  required = \"required\" style=\"text-align: right;width:100%;border:1px solid a2a2a2;\" size=\"4%\"class=\"decimal-places-amt\"  name=\"listRateContDtl["+(rowCount)+"].dblDiscountPercent\" id=\"txtDiscountOnMRP."+(rowCount)+"\" value='"+discountPercent+"' >";
		    row.insertCell(7).innerHTML= "<input type=\"text\"  required = \"required\" style=\"text-align: right;width:100%;border:1px solid a2a2a2;\" size=\"4%\"class=\"decimal-places-amt\"  name=\"listRateContDtl["+(rowCount)+"].dblDiscount\" id=\"txtDiscount."+(rowCount)+"\" value='"+discount+"' >";
		    row.insertCell(8).innerHTML= "<input size=\"32%\" type=\"text\" style=\"border:1px solid a2a2a2;\" name=\"listRateContDtl["+(rowCount)+"].strNarration\" id=\"txtNarrtion."+(rowCount)+"\" value='"+narration+"' >";
		    row.insertCell(9).innerHTML= '<input type="button" value = "Delete"  class="deletebutton" onClick="Javacsript:funDeleteRow(this)">';
		    listRow++;
					...
					<div class="row transTable">
				      ...
				      <div class="col-md-2">
				       ...
				       <div class="col-md-2">
						...
						<div class="col-md-2">
							<label>Rate</label>
							<input id="txtRate" type="text"  value ="0" class="decimal-places-amt numberField"></input>
						</div>
						<div class="col-md-2"></div>
						<div class="col-md-2">
				       		<label id="lblProduct">Discount On</label>
				   			<s:select id="cmbDiscountOn" path="strDiscountOn" items="${discOnList}" style="width:100%;"/>
				      	</div>
						<div class="col-md-2">
							<label>Discount % On MRP</label>
							<input id="txtDiscountOnMRP" type="text" value="0" class="decimal-places numberField"></input>
						</div>
						<div class="col-md-2">
						...
						<div class="dynamicTableContainer" style="height: 260px">
							<table style="height:20px;border:#0F0;width:100%;font-size:11px; font-weight: bold;">	
								<tr bgcolor="#c0c0c0" >
									...
									<td width="7%">UOM</td><!--  COl4   -->
									<td width="3%">Rate</td><!--  COl5   -->
									<td width="5%">Discount On</td><!--  COl6   -->
									<td width="4%">Discount %</td><!--  COl7   -->
									<td width="2%">Discount</td><!--  COl8   -->
									<td width="15%">Narration</td><!--  COl9   -->		
									<td width="5%">Delete</td><!--  COl10   -->
								</tr>
							</table>
							<div style="background-color:#fbfafa; border: 1px solid #ccc;display: block; height: 210px; margin: auto; overflow-x: hidden;overflow-y: scroll;width: 99.8%;">
							   <table id="tblProduct" style="width:100%;border: #0F0; table-layout:fixed; overflow:scroll" class="transTablex col10-center">
									<tbody>    
										<col style="width:4%"><!--  COl1   -->
										<col style="width:16%"><!--  COl2   -->
