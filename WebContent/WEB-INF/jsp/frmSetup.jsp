...
<script type="text/javascript">
	...
	//alert(strCriteria);
		...
		row.insertCell(0).innerHTML = "<input name=\"listclsWorkFlowForSlabBasedAuth["
			+ (rowCount - 1)
			+ "].strLocCode\" size=\"27%\" class=\"Box\"  readonly=\"readonly\" id=\"cmbLocation."
			+ (rowCount - 1) + "\" value=\"" + strLocCode + "\">";
		...
		row.insertCell(10).innerHTML = "<input name=\"listclsWorkFlowForSlabBasedAuth["
				+ (rowCount - 1)
				+ "].strUser5\" size=\"12%\" class=\"Box\"  readonly=\"readonly\"  id=\"strUser5_SB."
				+ (rowCount - 1) + "\" value=" + strUser5 + " >";
		row.insertCell(11).innerHTML = '<input type="button" value = "Delete" class="deletebutton" onClick="Javacsript:funDeleteRow_SB(this)">';
		return false;
	}
	...
	function funChangeLocationCombo(locCode) {
		var propCode = $("#strProperty").val();
	...
	function getContextPath() 
	{
		...
		function funCreateSMS()
		{
			...
			var content='';
			var mainSMS =$("#txtPOSMSContent").val();
			...
			mainSMS+=content;
			$("#txtPOSMSContent").val(mainSMS);
		}
		
		function funCreateSMSGRN()
		{
			
			var field =$("#cmbGRNSMSField").val();
			var content='';
			var mainSMS =$("#txtGRNSMSContent").val();
			...
			$("#txtGRNSMSContent").val(mainSMS);
			
		}
		
		function funCreateSMSInvoice()
		{
			
			var field =$("#cmbInvoiceSMSField").val();
			var content='';
			var mainSMS =$("#txtInvoiceSMSContent").val();
			...
			$("#txtInvoiceSMSContent").val(mainSMS);
		
		}
		
		function funCreateSMSAuth()
		{
			
			var field =$("#cmbAuthSMSField").val();
			var content='';
			var mainSMS =$("#txtAuthSMSContent").val();
...
<body onload="funGetImage()">
	...
	<div>
		<s:form action="saveSetupData.html?saddr=${urlHits}" method="POST" name="setupForm" modelAttribute="setUpAttribute" enctype="multipart/form-data">
			...
			<br/>
			<!--  Start of tabContainer  funGetProperty(this.value)-->
			<div style="border: 0px solid black; width: 100%;height:100%; margin-left: auto; margin-right: auto;">
				<div id="tab_container">
						...
						<div id="tab2" class="tab_content">
							...
							<br>
								<div class="row transTable">
									...
									<div class="col-md-2">
										<label>PO/GRN Rate PickUp From</label>
									...
									<div class="col-md-2"></div>
									<div class="col-md-2">	
										<label>ShowLocationWiseCustomer</label>
										<s:checkbox path="strShowLocationWiseCustomer" value="Y"/>
									</div>
					...
					<s:select id="cmbLocation" path="strLocation">
			    		<s:options items="${listLocation}"/>
							...
							<table style="width: 100%;font-size:11px; font-weight: bold;">
								<tr bgcolor="#c0c0c0">
									<td style="width: 18%; height: 12px;" align="center">Location Name</td>
							...
							<div id="divSlabBase"style="width: 100%; bgcolor: #d8edff; overflow: scroll;height: 150PX; background:#fbfafa;">
								<table id="tblAuthorizationSlabBased" style="overflow: scroll;margin-left: auto;
									margin-right: auto;width: 100%;" class="transTablex col12-center">
									<tr>
										<td style="width: 12%; height: 12px;" align="center"></td>
									...
									<c:forEach items="${listclsWorkFlowForSlabBasedAuth}"
										...
										<tr>
									 	...
									 	<td style="width: 16%; height: 12px;"><input size="27%" class="Box"  readonly="readonly"
												name="listclsWorkFlowForSlabBasedAuth[${status.index}].strLocCode"
												value="${SB.strLocCode}" /></td> 
						...
						<div id="tab10" class="tab_content">
							...
							<div id="tblAudit" class="row transTable">
								...
								<div class="col-md-2">
										<label>PO</label><br>
										<s:checkbox path="strSendPOMsg" value="Y" />
									</div>
									<div class="col-md-2">
									<s:textarea cssStyle="height: 28px; margin-top:22px;" id="txtPOSMSContent" path="strPOMsgContent"  />
							<!-- 	<s:textarea cssStyle="height: 28px; margin-top:22px;" id="txtSMSContent" path="strSMSContent"  />  -->
								...
								<div class="col-md-1">
							 		<input type="button" value="Add" class="btn btn-primary center-block" onclick="funCreateSMS();" id="btnAddSMSPO" style="margin-top:22px;"/>
							 	</div>
								<div class="col-md-2"></div><div class="col-md-2"></div>
								
									<div class="col-md-2">
										<label>GRN</label><br>
										<s:checkbox path="strSendGRNMsg" value="Y" />
									</div>
									<div class="col-md-2">
									<s:textarea cssStyle="height: 28px; margin-top:22px;" id="txtGRNSMSContent" path="strGRNMsgContent"  />
								</div>
								<div class="col-md-3">
									<label >SMS Content For GRN</label>
									<select  id="cmbGRNSMSField" class="BoxW48px" style="width:80%;" >
										<option value="CompanyName">Company Name</option>
										<option value="PropertyName">Property Name</option>
										<option value="SupplierName">Supplier Name</option>
										<option value="ContactPerson">Contact Person</option>
										<option value="MobileNo">Mobile No</option>
										<option value="GRNCode">GRN Code</option>
								...
								<div class="col-md-1">
							 		<input type="button" value="Add" class="btn btn-primary center-block" onclick="funCreateSMSGRN();" id="btnAddSMSGRN" style="margin-top:22px;"/>
							 	</div>
								<div class="col-md-2"></div>
								<div class="col-md-2"></div>
									<div class="col-md-2">
										<label>Invoice</label><br>
										<s:checkbox path="strSendInvoiceMsg" value="Y" />
									</div>
								<div class="col-md-2">
									<s:textarea cssStyle="height: 28px; margin-top:22px;" id="txtInvoiceSMSContent" path="strInvoiceMsgContent"  />
								</div>
								<div class="col-md-3">
									<label >SMS Content For Invoice</label>
									<select  id="cmbInvoiceSMSField" class="BoxW48px" style="width:80%;" >
										<option value="CompanyName">Company Name</option>
										<option value="PropertyName">Property Name</option>
										<option value="SupplierName">Supplier Name</option>
										<option value="ContactPerson">Contact Person</option>
								...
								<div class="col-md-1">
							 		<input type="button" value="Add" class="btn btn-primary center-block" onclick="funCreateSMSInvoice();" id="btnAddSMSInvoice" style="margin-top:22px;"/>
							 	</div>
								<div class="col-md-2"></div>
								<div class="col-md-2"></div>
									<div class="col-md-2">
										<label>Authorization</label><br>
										<s:checkbox path="strSendAuthMsg" value="Y" />
									</div>
									<div class="col-md-2">
									<s:textarea cssStyle="height: 28px; margin-top:22px;" id="txtAuthSMSContent" path="strAuthMsgContent"  />
								</div>
					
								
								<div class="col-md-3">
									<label >SMS Content For User Authorization</label>
									<select  id="cmbAuthSMSField" class="BoxW48px" style="width:80%;" >
										<option value="CompanyName">Company Name</option>
										<option value="PropertyName">Property Name</option>
										<option value="ContactPerson">Contact Person</option>
						 	...
						 	<div class="col-md-1">
							 		<input type="button" value="Add" class="btn btn-primary center-block" onclick="funCreateSMSAuth();" id="btnAddSMSAuth" style="margin-top:22px;"/>
							 	</div>
