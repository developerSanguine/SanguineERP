			...
			$.ajax({
					...
					success : function(response) {
						if('Invalid Code' == response.strReasonCode){
							...
							document.getElementById("chkBillPassing").checked = response.strBillPassing == 'Y' ? true: false;
	...
	<div class="container masterTable">
	   ...
	   <s:form method="POST" name="reasonForm" action="savereasonmaster.html?saddr=${urlHits}">
		...
		<div class="row" id="thirdRow">
			...
			</div><div class="col-md-2"><label>Bill Passing</label><br>
				<s:checkbox element="li" id="chkBillPassing" path="strBillPassing" value="true" />
			</div>
