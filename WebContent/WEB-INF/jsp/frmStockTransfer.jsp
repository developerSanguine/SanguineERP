...
.transTable{
	...
	var ProductCodeVar=-1;
		...
		{ 
		    ...
		    row.insertCell(1).innerHTML= "<input readonly=\"readonly\" class=\"Box\" size=\"50%\" name=\"listStkTransDtl["+(rowCount)+"].strProdName\" id=\"lblProdName."+(rowCount)+"\" value='"+prodName+"' />";		   
		    row.insertCell(2).innerHTML= "<input readonly=\"readonly\" class=\"Box\" size=\"9%\" name=\"listStkTransDtl["+(rowCount)+"].strProdType\" id=\"lblProdType."+(rowCount)+"\" value='"+gProdType+"' />";		   
		    ...
		    row.insertCell(8).innerHTML= "<input readonly=\"readonly\" class=\"Box\" size=\"8%\" style=\"text-align: right;\" name=\"listStkTransDtl["+(rowCount)+"].dblTotalWt\" id=\"txtTotalWt."+(rowCount)+"\" value='"+totalWt+"' />";		   		    
		    row.insertCell(9).innerHTML= "<input size=\"10%\" name=\"listStkTransDtl["+(rowCount)+"].strRemark\" id=\"txtRemarks."+(rowCount)+"\" value='"+remarks+"'/>";
		...
		<div class="dynamicTableContainer" style="height: 300px;">
			<table style="height: 28px; border: #0F0; width: 100%;font-size:11px; font-weight: bold;">
				<tr bgcolor="#c0c0c0">
					...
					<td width="25%">Product Name</td><!-- col2   -->
					<td width="5%">Product Type</td><!-- col3   -->
					<td width="3%">UOM</td><!-- col4   -->
					<td width="4%">Quantity</td><!-- col5   -->
					<td width="5%">Unit Price</td><!-- col6   -->
					<td width="6%">Total Price</td><!-- col7   -->
					<td width="3%">Wt/Unit</td><!-- col8  -->
					<td width="7%" style="padding-left: 20px;">Total Wt</td><!-- col9   -->
					<td width="8%">Remarks</td><!-- col10   -->
