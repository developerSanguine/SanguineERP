			...
			$.ajax({
		        ...
		        success: function(response)
		        {
		        	if('Invalid Code' == response.strUserCode1){
			        	...
			        	if(response.strExpiryItemNotification=='Y')
				    	{
				    		document.getElementById("chkExpiryItem").checked=true;
				    	}else{
				    		document.getElementById("chkExpiryItem").checked=false;
				    	}
			        	
			        	$("#cmbProperty").val(response.strProperty);
			        	$("#txtExpiryDays").val(response.intExpiryItemDays);
		...
		<s:form action="saveUserMaster.html?saddr=${urlHits}" method="POST" name="userForm">
			<div class="row masterTable" >
				...
				<div class="col-md-4"></div>
					<br><br><br>
					<div class="col-md-2">
						<label>Expiry Days Notification</label><br>
						<s:checkbox  colspan="3" id="chkExpiryItem" path="strExpiryItemNotification"  value="" />				
					</div>		
					
					<div class="col-md-2">					
						<label>Expiry Item Days</label>
			  			<s:input id="txtExpiryDays" name="intExpiryItemDays"  type="text" value="" path="intExpiryItemDays"/>
					 </div>
					<div class="col-md-2">	 
					      	<label> Mobile No.  </label>
					      	
					      	<s:input  type="text" pattern="[0-9]{10,10}"  maxlength="11"  placeholder="Enter Valid MobileNo." id="txtMobile" name="txtMobile" path="strMobileNo" />
					     </div>
