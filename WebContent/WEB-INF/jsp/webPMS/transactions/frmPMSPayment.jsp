...
<script type="text/javascript">
	...
	$(function() 
	{
		...
		$("#txtPaymentDate").datepicker('setDate', pmsDate);		
	...
	function funSetReceiptInfo(response)
	{
		...
		$("#txtPaymentDate").val(response.dtePaymentDate);
	  ...
	  <s:form name="Payment" method="GET" action="savePMSPayment.html">
	   ...
	   <div class="row">
            <div class="col-md-2"><label>Payment Receipt No</label>
			 ...
			 <div class="col-md-2"><label id="lbPaymentDate">Payment Date</label>
			        <s:input type="text" id="txtPaymentDate" path="dtePaymentDate" cssClass="calenderTextBox" />
		         </div>
