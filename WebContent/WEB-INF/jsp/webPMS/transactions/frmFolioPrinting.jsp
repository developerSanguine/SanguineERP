...
/*	function funSetFolioNo(folioNo)
	...
	*/
	function funSetFolioNo(folioNo)
	{
		...
		$("#strFolioNo").val(folioNo);
		var searchurl=getContextPath()+ "/loadDataForFolio.html?folioNo=" + folioNo;
		$.ajax({
			type : "GET",
			url : searchurl,
			dataType : "json",
    ...
    <div class="row">
            <div class="col-md-2"><label>Folio No.</label>
			 ...
			 <div class="col-md-2"><label>Guest Name</label>
				      <s:input id="strGuestName" path="" readonly="true" cssClass="longTextBox"  style=" width: 150%; height: 45%;" />													
	            </div>
