...
// Get Detail Info From detail fields and pass them to function to add into detail grid
	...
	/*
		...
		var flagReserveRoomCheckConfirm = funCheckRoomAvailability();
		if(flagReserveRoomCheckConfirm)
		{
		...
		var searchurl=getContextPath()+"/CheckRoomAvailability.html?RoomNo="+roomNo+"&ArrivalDate="+arrDate+"&departureDate="+depDate;
		 $.ajax({
			        ...
			        success: function(response)
			        {
			        	...
			        	{
			        		var flagRoomCheckConfirm=confirm("Room is Reserved\n Reservaation number is :"+response[0][0]+"\n Arrival Date:"+response[0][1]+" Departure Date"+response[0][2]+
			        				"/n Do You Want To Still Reserved The Same Room");
			        		if(flagRoomCheckConfirm)
			        		{
			        			flagRoom=true;
			        		}else{
			        			flagRoom=false;
