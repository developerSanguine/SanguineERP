	...
	<script type="text/javascript">
											...
											dblReceiveConversion,strIssueUOM,dblIssueConversion,strRecipeUOM,dblRecipeConversion) 
		{
		    ...
		    row.insertCell(2).innerHTML= "<input name=\"listProdModel["+(rowCount)+"].strSGCode\"    required = \"required\" size=\"7%\" style=\"background-position: 70px 2px;;width:100%\" readonly=\"readonly\" class=\"searchTextBox\" id=\"strSGCode."+(rowCount)+"\" value='"+strSGCode+"' />"; 
		   	row.insertCell(3).innerHTML= "<input type=\"text\"  required = \"required\" size=\"10%\" style=\"width:100%\" class=\"Box\" id=\"strSGName."+(rowCount)+"\" value='&nbsp;&nbsp;"+strSGName+"'>";
		    ...
		    row.insertCell(5).innerHTML= "<input name=\"listProdModel["+(rowCount)+"].strLocCode\" type=\"text\"   style=\"background-position: 70px 2px;;width:100%\" size=\"7%\" class=\"searchTextBox\" id=\"strLocCode."+(rowCount)+"\" value='"+strLocCode+"'  />";
		   	row.insertCell(6).innerHTML= "<input type=\"text\"  required = \"required\" style=\"width:100%\" size=\"10%\" class=\"Box\" id=\"strLocName."+(rowCount)+"\" value='&nbsp;&nbsp;"+strLocName+"'>";
		...
		function pageselectCallback(page_index, jq)
		{
		    ...
		    var rowCount=0;
			    ...
			    for(var i=page_index*items_per_page;i<max_elem;i++)
			    {
			        ...
			        newcontent += '<td>'+ "<input name=\"listProdModel["+(i)+"].strProdName\" readonly=\"readonly\" class=\"Box\" size=\"20px\" id=\"lblProdName."+(i)+"\" value='"+productMasterData[i].strProdName+"' /></td>";
...
// 			        newcontent += '<td>'+ "<input name=\"listProdModel["+(rowCount)+"].strLocCode\" type=\"text\"  required = \"required\" style=\"background-position: 70px 2px;;width:100%\" size=\"10%\" class=\"searchTextBox\" id=\"strLocCode."+(rowCount)+"\" value='"+productMasterData[rowCount].strLocCode+"'  /></td>";
			        ...
			        newcontent += '<td>'+ "<input type=\"text\"  required = \"required\" style=\"width:100px\" size=\"22px\" class=\"Box\" id=\"strLocName."+(i)+"\" value='&nbsp;&nbsp;"+productMasterData[i].strLocName+"'></td>";
			        ...
			        newcontent += '<td>'+ "<select name=\"listProdModel["+(i)+"].strProdType\" class=\"BoxW48px\" style=\"width: 130px;\" readonly=\"readonly\" id=\"cmbProdType."+(i)+"\"  >'"+funGetProdType(productMasterData[i].strProdType)+"'</td>"; 
...
// 			        newcontent += '<td>'+ "<input name=\"listProdModel["+(rowCount)+"].strTaxIndicator\" type=\"checkbox\"   size=\"4%\" class=\"inputText-Auto\" id=\"strTaxIndicator."+(rowCount)+"\" value='"+productMasterData[rowCount].strTaxIndicator+"'></td>";
			        ...
			        newcontent += '<td>'+ "<select name=\"listProdModel["+(i)+"].strReceivedUOM\" class=\"Box\" style=\"width:100px\"  id=\"strReceivedUOM."+(i)+"\"  "+getProductTypeUOM(productMasterData[i].strReceivedUOM)+"  ";
			        ...
			        newcontent += '<td>'+ "<select name=\"listProdModel["+(i)+"].strIssueUOM\" style=\"width:100px\"  class=\"Box inputText-Auto\" id=\"strIssueUOM."+(i)+"\" "+getProductTypeUOM(productMasterData[i].strIssueUOM)+" ";
			        ...
			        newcontent += '<td>'+ "<select name=\"listProdModel["+(i)+"].strRecipeUOM\" style=\"width:100px\" class=\"Box\"  id=\"txtRecipeUOM."+(i)+"\"  "+getProductTypeUOM(productMasterData[i].strRecipeUOM)+"  ";
