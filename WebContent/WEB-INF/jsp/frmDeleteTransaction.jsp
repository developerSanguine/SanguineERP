...
<title>Insert title here</title>
	...
	<script>
		...
		$(function ()
		{
			 ...
			 if(moduleName=='3-WebPMS')
			 {
				 ...
				 $("#txtReason").css('visibility', 'hidden');
				 $("#lblReasonName").css('visibility', 'hidden');
				 $("#headingReason").css('visibility', 'hidden');
		...
		function funSetData(code)
		{
			 ...
			 if($("#cmbFormName").val()=='ReservationNo' || $("#cmbFormName").val()=='WalkinNo'
		    		||$("#cmbFormName").val()=='checkIn'||$("#cmbFormName").val()=='receiptNo'
		    		||$("#cmbFormName").val()=='refundReceiptNo'){
			...
			if($("#txtNarration").val()=="" &&$("#txtReason").val()=="" )
			{
			 ...
			 if($("#cmbFormName").val()=='ReservationNo' || $("#cmbFormName").val()=='WalkinNo'
				 ...
				 if(flag){
					 ...
					 document.frmDelTrans.action = "PMSdeleteTransaction.html";
					 document.frmDelTrans.method = "POST";
	...
	<div class="container">
		...
		<s:form id="frmDelTrans" name="frmDelTrans" method="POST" action="deleteTransaction.html">
		   ...
		   <div class="row masterTable">
				...
				<div class="col-md-4">	</div>	
			   	<div class="col-md-2">
			    	<label id="headingReason">Reason</label>
