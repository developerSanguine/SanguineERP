		 ...
		 function btnSubmit_Onclick() 
			{	
			    ...
			    else
				{
					...
					document.forms[0].action = "rptPurchaseReturnReport.html";
				}
...
<body>
	<div class="container transTable">
	  <label id=lblFormHeader>Purchase Return Report</label>
	   <s:form id="formTag" name="frmReceiptRegister" method="POST" action="rptPurchaseReturnReport.html" target="_blank">
